...
contains
  ...
  subroutine CAMMGMP(itimestep, dt, p8w, p_hyd   &
    ...
    real, dimension( ims:ime, kms:kme, jms:jme, ntot_amode ), intent(in) :: dgnum4d, dgnumwet4d 
    ...
    real, dimension( ims:ime, kms:kme, jms:jme ), intent(inout) :: qme3d          
    real, dimension( ims:ime, kms:kme, jms:jme ), intent(inout) :: prain3d        
    real, dimension( ims:ime, kms:kme, jms:jme ), intent(inout) :: nevapr3d       
    real, dimension( ims:ime, kms:kme, jms:jme ), intent(inout) :: rate1ord_cw2pr_st3d 
             ...
             if(chem_opt.NE.0 .and. config_flags%CAM_MP_MAM_cpled ) then
                ...
                do imode = 1 , ntot_amode
                   if(is_first_step) then
                      dgnum(1,kflip,imode)    = 0.0_r8 
                      dgnumwet(1,kflip,imode) = 0.0_r8
                   else
                      dgnum(1,kflip,imode)    = dgnum4D(iw,kw,jw,imode)   
