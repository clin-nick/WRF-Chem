 ...
 character(len=16), parameter :: version_p3  = '2.8.2'          
 character(len=1024)          :: version_header_table1          
 character(len=1024)          :: version_header_table2          
...
END SUBROUTINE P3_INIT
 ...
 real,    parameter                       :: freq3DtypeDiag     = 60.     
