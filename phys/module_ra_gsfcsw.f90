      ...
      do i = its,ite
        ...
        if(tauaer300(i,k+1,j).gt.thresh .and. tauaer999(i,k+1,j).gt.thresh .and. &
           ...
           if(tauaer300(i,k+1,j).gt.tauaer999(i,k+1,j)) then 
            ...
            taual(i,kte-k,ib)=tauaer400(i,k+1,j)*(0.4/midbands(ib))**ang 
            ...
            if(midbands(ib) .lt. 0.5) then
             ...
             taual(i,kte-k,ib)=tauaer600(i,k+1,j)*(0.6/midbands(ib))**ang 
            endif
           endif
           ...
           ssaal(i,kte-k,ib) = slope*(midbands(ib)-.6)+waer600(i,k+1,j) 
           ...
           asyal(i,kte-k,ib) = slope*(midbands(ib)-.6)+gaer600(i,k+1,j) 
