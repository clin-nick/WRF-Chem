...
MODULE cri_mosaic_8bin_aq_UpdateRconstWRF
...
SUBROUTINE cri_mosaic_8bin_aq_Update_RCONST(  &
...
ind_rtx28o2,ind_rn19o2,ind_nrn12ooh,ind_hoch2co3,ind_no2, &
 ...
 INTEGER, INTENT(in) ::  &
  ...
  RCONST(636) = (9.d-11)
  RCONST(637) = (1.0d-13)
END SUBROUTINE cri_mosaic_8bin_aq_Update_RCONST
...
END MODULE cri_mosaic_8bin_aq_UpdateRconstWRF
