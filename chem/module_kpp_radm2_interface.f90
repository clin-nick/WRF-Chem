...
MODULE module_kpp_radm2_interf 
  ...
  USE radm2_Precision
  USE radm2_UpdateRconstWRF
  USE radm2_Integrator
...
rc_n2o5, &
  ...
  CALL radm2_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  radm2_interface


END MODULE module_kpp_radm2_interf 
