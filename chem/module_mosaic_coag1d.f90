...
2800	continue	
	...
	return
      ...
      real(r8), intent(in) :: dpdry(nbin_maxd)    
      real(r8), intent(in) :: dpwet(nbin_maxd)    
      real(r8), intent(in) :: denswet(nbin_maxd)  
      real(r8), intent(in) :: vpdry_in(nbin_maxd) 
...
solve_k_loop:   &
      ...
      real(r8), intent(in)  :: tempk            
      real(r8), intent(in)  :: press            
      real(r8), intent(in)  :: dpwet(nbin)      
      real(r8), intent(in)  :: denswet(nbin)    
      ...
      gasfreepathx2 = 4.0*viscosk/gasspeed
       ...
       do i = 1, nbin
          ...
          dpwet_i = dpwet(i)                    
          mass_i = pi6*denswet(i)*(dpwet_i**3)  
          ...
          do j = 1, nbin
             ...
             dpwet_j = dpwet(j)                    
             mass_j = pi6*denswet(j)*(dpwet_j**3)  
