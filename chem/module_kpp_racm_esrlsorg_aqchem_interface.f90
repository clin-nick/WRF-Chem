...
MODULE module_kpp_racm_esrlsorg_aqchem_interf 
  ...
  USE racm_esrlsorg_aqchem_UpdateRconstWRF
  USE racm_esrlsorg_aqchem_Integrator
...
SUBROUTINE  racm_esrlsorg_aqchem_interface( &
   ...
   CALL racm_esrlsorg_aqchem_Update_Rconst(  &
  ...
  CALL racm_esrlsorg_aqchem_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racm_esrlsorg_aqchem_interface


END MODULE module_kpp_racm_esrlsorg_aqchem_interf 
