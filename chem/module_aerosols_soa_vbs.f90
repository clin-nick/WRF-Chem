    ...
    END SUBROUTINE aeroproc
     ...
     REAL dgcor(blksize)
      ...
      real vaer
        ...
        deln2o5 = gn2o5-gn2o5*exp(-1*cblk(lcell,vkn2o5)*dt)      

        cblk(lcell,vyclno2)= 1/(1+ah2o/(483*acl))

        pclno2=deln2o5*cblk(lcell,vyclno2)   
        ...
        pno3 = deln2o5 * ( 2 - cblk(lcell,vyclno2) ) 
      ...
      DO lcell = 1,numcells
        ...
        WI(8) = DBLE((cblk(lcell,vmgaj)  + cblk(lcell,vmgai)) &
                ...
                CALL ISOROPIA2p1 (WI, RHI, TEMPI, CNTRL, &
                        ...
                        gnh3 = real(GAS(1)*DBLE(17.031)*1.D6) 
                        anh4 = real((wt(3) - gas(1))*DBLE(18.039)*1.D6)
                        gno3 = real(GAS(2)*DBLE(63.012)*1.D6) 
                        ano3 = real((wt(4) - gas(2))*DBLE(62.004)*1.D6)
                        ghcl = real(GAS(3)*DBLE(36.461)*1.D6) 
                        acl = real((wt(5) - gas(3))*DBLE(35.453)*1.D6)

                        aso4 = real(wt(2)*DBLE(96.061)*1.D6) 

                        ah2o = real(AERLIQ(8)*DBLE(18.015)*1.D6) 
...
do ll=1,nbin
 ...
 minit= 1.4*( cblk(lcell,vorgpaj) + cblk(lcell,vorgpai) ) 
