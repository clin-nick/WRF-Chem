...
MODULE module_kpp_cb05_sorg_vbs_aq_interf 
  ...
  USE cb05_sorg_vbs_aq_UpdateRconstWRF
  USE cb05_sorg_vbs_aq_Integrator
  ...
  USE HETAERO
  USE AERODATA
  USE module_data_sorgam_vbs, ONLY: palk4,palk5,pole1,pole2,paro1,paro2,pisop,pterp,psesq,pbrch, &
  lptr_so4_aer,lptr_no3_aer,lptr_cl_aer,lptr_nh4_aer,lptr_na_aer,lptr_p25_aer,lptr_orgpa_aer, &
  lptr_ec_aer,lptr_asoa1_aer,lptr_asoa2_aer,lptr_asoa3_aer,lptr_asoa4_aer,lptr_bsoa1_aer,     &
  lptr_bsoa2_aer,lptr_bsoa3_aer,lptr_bsoa4_aer,waterptr_aer,numptr_aer,lptr_anth_aer,         &
  lptr_seas_aer,lptr_soil_aer
...
SUBROUTINE  cb05_sorg_vbs_aq_interface( &
...
itype = 1
  ...
  rtdat_ae_so2 = REAL (RTDAT_AE( ISO2 ), KIND=dp)
   ...
   CALL cb05_sorg_vbs_aq_Update_Rconst(  &
  ...
  CALL cb05_sorg_vbs_aq_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  cb05_sorg_vbs_aq_interface


END MODULE module_kpp_cb05_sorg_vbs_aq_interf 
