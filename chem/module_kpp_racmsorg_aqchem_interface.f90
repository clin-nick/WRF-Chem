...
MODULE module_kpp_racmsorg_aqchem_interf 
  ...
  USE racmsorg_aqchem_UpdateRconstWRF
  USE racmsorg_aqchem_Integrator
...
SUBROUTINE  racmsorg_aqchem_interface( &
   ...
   CALL racmsorg_aqchem_Update_Rconst(  &
  ...
  CALL racmsorg_aqchem_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racmsorg_aqchem_interface


END MODULE module_kpp_racmsorg_aqchem_interf 
