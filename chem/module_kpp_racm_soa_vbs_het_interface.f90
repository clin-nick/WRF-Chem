...
MODULE module_kpp_racm_soa_vbs_het_interf 
  ...
  USE racm_soa_vbs_het_UpdateRconstWRF
  USE racm_soa_vbs_het_Integrator
...
SUBROUTINE  racm_soa_vbs_het_interface( &
...
REAL( KIND = dp ) :: rc_n2o5
   ...
   CALL racm_soa_vbs_het_Update_Rconst(  &
  ...
  CALL racm_soa_vbs_het_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racm_soa_vbs_het_interface


END MODULE module_kpp_racm_soa_vbs_het_interf 
