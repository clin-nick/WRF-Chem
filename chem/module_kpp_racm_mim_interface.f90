...
MODULE module_kpp_racm_mim_interf 
  ...
  USE racm_mim_UpdateRconstWRF
  USE racm_mim_Integrator
...
SUBROUTINE  racm_mim_interface( &
  ...
  CALL racm_mim_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racm_mim_interface


END MODULE module_kpp_racm_mim_interf 
