...
MODULE module_kpp_racmpm_interf 
  ...
  USE racmpm_UpdateRconstWRF
  USE racmpm_Integrator
...
SUBROUTINE  racmpm_interface( &
  ...
  CALL racmpm_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racmpm_interface


END MODULE module_kpp_racmpm_interf 
