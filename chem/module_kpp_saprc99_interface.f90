...
MODULE module_kpp_saprc99_interf 
  ...
  USE saprc99_UpdateRconstWRF
  USE saprc99_Integrator
...
SUBROUTINE  saprc99_interface( &
  ...
  CALL saprc99_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  saprc99_interface


END MODULE module_kpp_saprc99_interf 
