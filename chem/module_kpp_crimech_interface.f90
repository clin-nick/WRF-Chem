...
MODULE module_kpp_crimech_interf 
  ...
  USE crimech_UpdateRconstWRF
  USE crimech_Integrator
...
ind_rtx28o2,ind_rn19o2,ind_nrn12ooh,ind_hoch2co3,ind_no2, &
  ...
  CALL crimech_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  crimech_interface


END MODULE module_kpp_crimech_interf 
