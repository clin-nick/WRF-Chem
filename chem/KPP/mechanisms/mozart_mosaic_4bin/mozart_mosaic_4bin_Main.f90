...
! 
! File                 : mozart_mosaic_4bin_Main.f90
...
PROGRAM mozart_mosaic_4bin_Driver

  USE mozart_mosaic_4bin_Model
  USE mozart_mosaic_4bin_Initialize, ONLY: Initialize
...
END PROGRAM mozart_mosaic_4bin_Driver
