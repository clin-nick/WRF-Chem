...
#ifdef FULL_ALGEBRA    
     CALL racmpm_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL racmpm_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  racmpm_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
   CALL racmpm_KppDecomp ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1
...
#ifdef FULL_ALGEBRA    
   CALL  racmpm_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL racmpm_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racmpm_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of racmpm_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racmpm_IRRFun - accumulated time derivatives of variables - Agregate form
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of racmpm_IRRFun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racmpm_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racmpm_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of racmpm_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
