...
! 
! File                 : racm_esrlsorg_Monitor.f90
...
MODULE racm_esrlsorg_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_0 = (/ &
     ...
     '       HONO --> HO + NO                                                                             ', &
     '       HNO3 --> HO + NO2                                                                            ', &
     '       HNO4 --> 0.35 HO + 0.35 NO3 + 0.65 HO2 + 0.65 NO2                                            ', &
     '        NO3 --> NO                                                                                  ', &
     '        NO3 --> O3P + NO2                                                                           ', &
     '       H2O2 --> 2 HO                                                                                ', &
     '       HCHO --> CO                                                                                  ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     '   ETH + HO --> ETHP + H2O                                                                          ', &
     '   HC3 + HO --> 0.036 ORA1 + 0.036 CO + 0.036 GLY + 0.01 HCHO + 0.335 ALD + 0.583 HC3P + 0.036 HO + ', &
     ...
     '  MGLY + HO --> CO + ACO3 + H2O                                                                     ', &
     '  MACR + HO --> MACP                                                                                ', &
     '   DCB + HO --> 0.35 UDD + 0.15 GLY + 0.15 MGLY + 0.5 XO2 + 0.5 HO2 + 0.5 TCO3                      ', &
     '   UDD + HO --> 0.12 KET + 0.88 ALD + HO2                                                           ', &
     '   OP1 + HO --> 0.35 HCHO + 0.35 HO + 0.65 MO2                                                      ', &
     '   OP2 + HO --> 0.41 KET + 0.07 XO2 + 0.08 ALD + 0.44 HC3P + 0.49 HO                                ', &
     '   PAA + HO --> 0.35 HCHO + 0.35 XO2 + 0.65 ACO3 + 0.35 HO2                                         ', &
     '   PAN + HO --> HCHO + XO2 + NO3 + H2O                                                              ', &
     '  TPAN + HO --> 0.6 HKET + 0.4 PAN + 0.4 HCHO + XO2 + 0.6 NO3 + 0.4 HO2                             ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '  MAHP + HO --> MACP                                                                                ', &
     '  DCB + NO3 --> 0.5 HNO3 + 0.25 GLY + 0.03 KET + 0.25 MGLY + 0.5 XO2 + 0.25 ALD + 0.5 HO2 + 0.5 TCO3', &
     '  CSL + NO3 --> PHO + HNO3                                                                          ', &
     ...
     ' TPAN + NO3 --> 0.4 PAN + 0.4 HCHO + 0.6 ONIT + XO2 + 0.6 NO3 + 0.4 NO2                             ', &
     '   ETE + O3 --> 0.37 ORA1 + 0.43 CO + HCHO + 0.12 HO + 0.26 HO2                                     ', &
     '   OLT + O3 --> 0.14 ORA1 + 0.1 ORA2 + 0.06 CH4 + 0.03 ETH + 0.006 H2O2 + 0.37 CO + 0.03 KET + 0.64 ', &
     '   OLI + O3 --> 0.14 ORA2 + 0.07 CH4 + 0.06 ETH + 0.011 H2O2 + 0.3 CO + 0.16 KET + 0.02 HCHO + 0.99 ', &
     '  DIEN + O3 --> 0.15 ORA1 + 0.001 H2O2 + 0.09 O3P + 0.36 CO + 0.39 MACR + 0.9 HCHO + 0.13 XO2 + 0.35', &
     '   ISO + O3 --> 0.28 ORA1 + 0.09 H2O2 + 0.14 CO + 0.1 MACP + 0.65 MACR + 0.58 HCHO + 0.1 ACO3 + 0.25', &
     '   API + O3 --> 0.02 H2O2 + 0.14 CO + 0.53 KET + 0.65 ALD + 0.2 ETHP + 0.42 KETP + 0.85 HO + 0.1 HO2', &
     '   LIM + O3 --> 0.01 ORA1 + 0.07 ORA2 + 0.02 H2O2 + 0.14 CO + 0.79 MACR + 0.04 HCHO + 0.46 OLT + 0.1', &
     '  MACR + O3 --> 0.45 ORA1 + 0.22 CO + 0.9 MGLY + 0.1 ACO3 + 0.19 HO + 0.32 HO2                      ', &
     '   DCB + O3 --> 0.11 ORA1 + 0.21 ORA2 + 0.11 PAA + 0.66 CO + 0.5 GLY + 0.62 MGLY + 0.16 ALD + 0.28 A', &
     '  TPAN + O3 --> 0.11 ORA1 + 0.3 PAN + 0.13 CO + 0.7 HCHO + 0.7 ACO3 + 0.036 HO + 0.08 HO2 + 0.7 NO2 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '   MO2 + NO --> HCHO + HO2 + NO2                                                                    ', &
     '  ETHP + NO --> ALD + HO2 + NO2                                                                     ', &
     '  HC3P + NO --> 0.063 GLY + 0.623 KET + 0.047 HCHO + 0.059 ONIT + 0.048 XO2 + 0.233 ALD + 0.048 ETHP', &
     '  HC5P + NO --> 0.722 KET + 0.021 HCHO + 0.124 ONIT + 0.334 XO2 + 0.211 ALD + 0.245 ETHP + 0.599 HO2', &
     '  HC8P + NO --> 0.642 KET + 0.261 ONIT + 0.416 XO2 + 0.15 ALD + 0.133 ETHP + 0.606 HO2 + 0.739 NO2  ', &
     ...
     '  KETP + NO --> 0.54 MGLY + 0.16 XO2 + 0.46 ALD + 0.23 ACO3 + 0.77 HO2 + NO2                        ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     ' HC3P + MO2 --> 0.119 GLY + 0.018 KET + 0.005 MGLY + 0.81 HCHO + 0.085 XO2 + 0.58 ALD + 0.992 HO2 + ', &
     ' HC5P + MO2 --> 0.24 KET + 0.829 HCHO + 0.245 XO2 + 0.523 ALD + 0.014 ETHP + 0.946 HO2 + 0.049 MO2  ', &
     ' HC8P + MO2 --> 0.419 KET + 0.753 HCHO + 0.322 XO2 + 0.411 ALD + 0.013 ETHP + 0.993 HO2             ', &
     ' ETEP + MO2 --> 1.55 HCHO + 0.35 ALD + HO2                                                          ', &
     ' OLTP + MO2 --> 0.081 KET + 1.25 HCHO + 0.669 ALD + HO2                                             ', &
     ' OLIP + MO2 --> 0.313 KET + 0.755 HCHO + 0.932 ALD + HO2                                            ', &
     ' ISOP + MO2 --> 0.55 MACR + 1.09 HCHO + 0.37 OLT + 0.08 OLI + HO2                                   ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     ' ACO3 + MO2 --> HCHO + HO2 + MO2                                                                    ', &
     ' ACO3 + MO2 --> ORA2 + HCHO                                                                         ', &
     ' MO2 + TCO3 --> 2 HCHO + ACO3 + HO2                                                                 ', &
     ' MO2 + TCO3 --> ORA2 + HCHO                                                                         ', &
     ' KETP + MO2 --> 0.3 HKET + 0.4 MGLY + 0.75 HCHO + 0.08 XO2 + 0.3 ALD + 0.12 ACO3 + 0.88 HO2         ', &
     ...
     'HC3P + ACO3 --> 0.499 ORA2 + 0.1 GLY + 0.127 KET + 0.004 MGLY + 0.091 HCHO + 0.071 XO2 + 0.724 ALD +', &
     'HC5P + ACO3 --> 0.495 ORA2 + 0.33 KET + 0.076 HCHO + 0.237 XO2 + 0.677 ALD + 0.018 ETHP + 0.438 HO2 ', &
     'HC8P + ACO3 --> 0.495 ORA2 + 0.581 KET + 0.318 XO2 + 0.497 ALD + 0.015 ETHP + 0.489 HO2 + 0.507 MO2 ', &
     ...
     '     2 ACO3 --> 2 MO2                                                                               ', &
     'ACO3 + TCO3 --> HCHO + ACO3 + MO2                                                                   ', &
     'KETP + ACO3 --> 0.5 ORA2 + 0.11 KET + 0.54 MGLY + 0.08 XO2 + 0.35 ALD + 0.12 ACO3 + 0.38 HO2 + 0.5 M', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '  NO3 + MO2 --> HCHO + HO2 + NO2                                                                    ', &
     ' ETHP + NO3 --> ALD + HO2 + NO2                                                                     ', &
     ' HC3P + NO3 --> 0.063 GLY + 0.67 KET + 0.048 HCHO + 0.051 XO2 + 0.243 ALD + 0.053 ETHP + 0.792 HO2 +', &
     ' HC5P + NO3 --> 0.828 KET + 0.021 HCHO + 0.391 XO2 + 0.239 ALD + 0.262 ETHP + 0.699 HO2 + 0.04 MO2 +', &
     ' HC8P + NO3 --> 0.88 KET + 0.587 XO2 + 0.187 ALD + 0.155 ETHP + 0.845 HO2 + NO2                     ', &
     ...
     ' ACO3 + NO3 --> MO2 + NO2                                                                           ', &
     ' NO3 + TCO3 --> HCHO + ACO3 + NO2                                                                   ', &
     ' KETP + NO3 --> 0.54 MGLY + 0.16 XO2 + 0.46 ALD + 0.23 ACO3 + 0.77 HO2 + NO2                        ', &
     ...
     '  ISHP + HO --> MACR + HO                                                                           ', &
     '  ISON + HO --> NALD + HACE                                                                         ', &
     '  MACP + NO --> 0.25 HACE + 0.25 CO + 0.5 MGLY + 0.75 HCHO + 0.25 ACO3 + 0.75 HO2 + NO2             ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(4) :: EQN_NAMES_8 = (/ &
     ' MACP + HO2 --> MAHP                                                                                ', &
     '     2 MACP --> HACE + 0.5 CO + MGLY + 0.5 HCHO + HO2                                               ', &
     ' MACP + NO2 --> MPAN                                                                                ', &
     '       MPAN --> MACP + NO2                                                                          ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(244) :: EQN_NAMES = (/&
...
END MODULE racm_esrlsorg_Monitor
