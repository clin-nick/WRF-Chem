...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE saprc99_mosaic_8bin_vbs2_aq_Model

      INTEGER nlhs, nrhs
      INTEGER plhs(*), prhs(*)
      INTEGER mxGetPr, mxCreateFull, mxGetM, mxgetN
      INTEGER VPtr, FPtr, RPtr, JVSPtr
      REAL(kind=dp) V(98), F(2), RCT(256)
      REAL(kind=dp) JVS(1121)
...
! Check for the right number of output arguments
     ...
     &JVS(1121)')
      ...
      plhs(1) = mxCreateDoubleMatrix(1121,1,0)

      VPtr = mxGetPr(prhs(1))
      CALL mxCopyPtrToReal8(VPtr,V,98)
      ...
      CALL mxCopyReal8ToPtr(JVS, JVSPtr, 1121)
