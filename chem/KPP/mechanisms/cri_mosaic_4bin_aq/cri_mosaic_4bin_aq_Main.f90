...
! 
! File                 : cri_mosaic_4bin_aq_Main.f90
...
PROGRAM cri_mosaic_4bin_aq_Driver

  USE cri_mosaic_4bin_aq_Model
  USE cri_mosaic_4bin_aq_Initialize, ONLY: Initialize
...
END PROGRAM cri_mosaic_4bin_aq_Driver
