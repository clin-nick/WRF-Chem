...
#ifdef FULL_ALGEBRA    
     CALL cbmz_bb_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL cbmz_bb_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_bb_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
   CALL cbmz_bb_KppDecomp ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1
...
#ifdef FULL_ALGEBRA    
   CALL  cbmz_bb_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL cbmz_bb_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_bb_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of cbmz_bb_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_bb_IRRFun - accumulated time derivatives of variables - Agregate form
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of cbmz_bb_IRRFun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_bb_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! JVS(10) = Jac_FULL(5,5)
  JVS(10) = 0
! JVS(11) = Jac_FULL(5,34)
  JVS(11) = 0.09*B(111)
! JVS(12) = Jac_FULL(5,35)
  JVS(12) = 0.39*B(141)
! JVS(13) = Jac_FULL(5,39)
  JVS(13) = 0.16*B(113)
! JVS(14) = Jac_FULL(5,45)
  JVS(14) = 0.46*B(147)
! JVS(15) = Jac_FULL(5,51)
  JVS(15) = 0.09*B(112)+0.16*B(114)+0.39*B(142)+0.46*B(148)
! JVS(16) = Jac_FULL(5,53)
  JVS(16) = 0.4*B(210)
! JVS(17) = Jac_FULL(5,55)
  JVS(17) = 0.4*B(211)
! JVS(18) = Jac_FULL(6,6)
  JVS(18) = -B(21)-B(23)
! JVS(19) = Jac_FULL(6,51)
  JVS(19) = B(8)
! JVS(20) = Jac_FULL(7,7)
  JVS(20) = -B(85)
! JVS(21) = Jac_FULL(7,50)
  JVS(21) = -B(86)
! JVS(22) = Jac_FULL(8,8)
  JVS(22) = -B(218)
! JVS(23) = Jac_FULL(8,50)
  JVS(23) = -B(219)
! JVS(24) = Jac_FULL(9,9)
  JVS(24) = -B(9)-B(59)
! JVS(25) = Jac_FULL(9,50)
  JVS(25) = -B(60)
...
! JVS(28) = Jac_FULL(10,52)
  JVS(28) = B(171)
! JVS(29) = Jac_FULL(10,53)
  JVS(29) = B(172)
! JVS(30) = Jac_FULL(11,11)
  JVS(30) = -B(123)
! JVS(31) = Jac_FULL(11,50)
  JVS(31) = -B(124)
! JVS(32) = Jac_FULL(12,12)
  JVS(32) = -B(6)-B(80)-B(82)
! JVS(33) = Jac_FULL(12,52)
  JVS(33) = B(75)
! JVS(34) = Jac_FULL(12,54)
  JVS(34) = B(76)
! JVS(35) = Jac_FULL(13,13)
  JVS(35) = -B(125)
! JVS(36) = Jac_FULL(13,50)
  JVS(36) = -B(126)
! JVS(37) = Jac_FULL(14,14)
  JVS(37) = -B(87)
! JVS(38) = Jac_FULL(14,34)
  JVS(38) = 0.06*B(111)
! JVS(39) = Jac_FULL(14,39)
  JVS(39) = 0.08*B(113)
! JVS(40) = Jac_FULL(14,50)
  JVS(40) = -B(88)
! JVS(41) = Jac_FULL(14,51)
  JVS(41) = 0.06*B(112)+0.08*B(114)
! JVS(42) = Jac_FULL(15,15)
  JVS(42) = -B(133)
! JVS(43) = Jac_FULL(15,26)
  JVS(43) = 0.4*B(129)+B(131)
! JVS(44) = Jac_FULL(15,50)
  JVS(44) = 0.4*B(130)
! JVS(45) = Jac_FULL(15,52)
  JVS(45) = -B(134)
! JVS(46) = Jac_FULL(15,54)
  JVS(46) = B(132)
! JVS(47) = Jac_FULL(16,16)
  JVS(47) = -B(5)-B(55)-B(70)
! JVS(48) = Jac_FULL(16,50)
  JVS(48) = -B(56)
! JVS(49) = Jac_FULL(16,52)
  JVS(49) = B(66)
! JVS(50) = Jac_FULL(16,55)
  JVS(50) = B(67)
! JVS(51) = Jac_FULL(17,17)
  JVS(51) = -B(89)
! JVS(52) = Jac_FULL(17,34)
  JVS(52) = 0.01*B(111)
! JVS(53) = Jac_FULL(17,39)
  JVS(53) = 0.01*B(113)
! JVS(54) = Jac_FULL(17,40)
  JVS(54) = 0.2*B(226)
! JVS(55) = Jac_FULL(17,50)
  JVS(55) = -B(90)
! JVS(56) = Jac_FULL(17,51)
  JVS(56) = 0.01*B(112)+0.01*B(114)
! JVS(57) = Jac_FULL(18,11)
  JVS(57) = 0.8*B(123)
! JVS(58) = Jac_FULL(18,13)
  JVS(58) = 0.45*B(125)
! JVS(59) = Jac_FULL(18,18)
  JVS(59) = -B(127)
! JVS(60) = Jac_FULL(18,50)
  JVS(60) = 0.8*B(124)+0.45*B(126)
! JVS(61) = Jac_FULL(18,56)
  JVS(61) = -B(128)
! JVS(62) = Jac_FULL(19,19)
  JVS(62) = -B(220)
! JVS(63) = Jac_FULL(19,29)
  JVS(63) = -B(221)
! JVS(64) = Jac_FULL(19,34)
  JVS(64) = 1.06*B(111)+B(115)
! JVS(65) = Jac_FULL(19,39)
  JVS(65) = 2.26*B(113)+2.23*B(117)
! JVS(66) = Jac_FULL(19,41)
  JVS(66) = B(186)+B(200)+B(230)
! JVS(67) = Jac_FULL(19,47)
  JVS(67) = 1.98*B(18)+0.42*B(167)
! JVS(68) = Jac_FULL(19,48)
  JVS(68) = 1.68*B(180)+1.98*B(194)+1.25*B(227)
! JVS(69) = Jac_FULL(19,49)
  JVS(69) = 1.98*B(19)
! JVS(70) = Jac_FULL(19,50)
  JVS(70) = B(116)+2.23*B(118)+0.42*B(168)
! JVS(71) = Jac_FULL(19,51)
  JVS(71) = 1.06*B(112)+2.26*B(114)
! JVS(72) = Jac_FULL(19,54)
  JVS(72) = 1.98*B(195)+B(201)
! JVS(73) = Jac_FULL(19,56)
  JVS(73) = 1.68*B(181)+B(187)
! JVS(74) = Jac_FULL(20,20)
  JVS(74) = -B(12)-B(163)
! JVS(75) = Jac_FULL(20,44)
  JVS(75) = B(204)
! JVS(76) = Jac_FULL(20,50)
  JVS(76) = -B(164)
! JVS(77) = Jac_FULL(20,55)
  JVS(77) = B(205)
! JVS(78) = Jac_FULL(21,21)
  JVS(78) = -B(13)-B(165)
! JVS(79) = Jac_FULL(21,40)
  JVS(79) = B(206)
! JVS(80) = Jac_FULL(21,50)
  JVS(80) = -B(166)
! JVS(81) = Jac_FULL(21,55)
  JVS(81) = B(207)
! JVS(82) = Jac_FULL(22,22)
  JVS(82) = -B(3)-B(51)
! JVS(83) = Jac_FULL(22,50)
  JVS(83) = B(45)-B(52)
! JVS(84) = Jac_FULL(22,52)
  JVS(84) = B(68)
! JVS(85) = Jac_FULL(22,55)
  JVS(85) = B(69)
! JVS(86) = Jac_FULL(22,56)
  JVS(86) = B(46)
! JVS(87) = Jac_FULL(23,23)
  JVS(87) = -B(107)-B(109)
! JVS(88) = Jac_FULL(23,50)
  JVS(88) = -B(110)
! JVS(89) = Jac_FULL(23,51)
  JVS(89) = -B(108)
! JVS(90) = Jac_FULL(24,24)
  JVS(90) = -B(174)
! JVS(91) = Jac_FULL(24,34)
  JVS(91) = 0.03*B(111)
! JVS(92) = Jac_FULL(24,39)
  JVS(92) = 0.04*B(113)
! JVS(93) = Jac_FULL(24,44)
  JVS(93) = 0.34*B(225)
! JVS(94) = Jac_FULL(24,50)
  JVS(94) = -B(175)
! JVS(95) = Jac_FULL(24,51)
  JVS(95) = 0.03*B(112)+0.04*B(114)
! JVS(96) = Jac_FULL(25,6)
  JVS(96) = B(21)
! JVS(97) = Jac_FULL(25,25)
  JVS(97) = -B(25)-B(27)-B(29)-B(31)-B(33)
! JVS(98) = Jac_FULL(25,51)
  JVS(98) = B(7)-B(28)
! JVS(99) = Jac_FULL(25,52)
  JVS(99) = B(1)-B(30)-B(32)
! JVS(100) = Jac_FULL(25,54)
  JVS(100) = 0.89*B(2)
! JVS(101) = Jac_FULL(25,56)
  JVS(101) = -B(34)
! JVS(102) = Jac_FULL(26,11)
  JVS(102) = 0.12*B(123)
! JVS(103) = Jac_FULL(26,13)
  JVS(103) = 0.05*B(125)
! JVS(104) = Jac_FULL(26,26)
  JVS(104) = -B(129)-B(131)
! JVS(105) = Jac_FULL(26,50)
  JVS(105) = 0.12*B(124)+0.05*B(126)-B(130)
! JVS(106) = Jac_FULL(26,54)
  JVS(106) = -B(132)
! JVS(107) = Jac_FULL(27,12)
  JVS(107) = 2*B(80)
! JVS(108) = Jac_FULL(27,26)
  JVS(108) = B(131)
! JVS(109) = Jac_FULL(27,27)
  JVS(109) = -B(4)-B(53)
! JVS(110) = Jac_FULL(27,36)
  JVS(110) = B(95)
! JVS(111) = Jac_FULL(27,42)
  JVS(111) = B(105)
! JVS(112) = Jac_FULL(27,43)
  JVS(112) = B(99)
! JVS(113) = Jac_FULL(27,45)
  JVS(113) = 0.07*B(149)
! JVS(114) = Jac_FULL(27,50)
  JVS(114) = B(47)-B(54)
! JVS(115) = Jac_FULL(27,52)
  JVS(115) = B(48)
! JVS(116) = Jac_FULL(27,54)
  JVS(116) = 0.3*B(78)+B(96)+B(100)+B(106)+B(132)+0.07*B(150)
! JVS(117) = Jac_FULL(27,55)
  JVS(117) = 0.3*B(79)
! JVS(118) = Jac_FULL(28,23)
  JVS(118) = 0.24*B(107)
! JVS(119) = Jac_FULL(28,28)
  JVS(119) = -B(83)
! JVS(120) = Jac_FULL(28,30)
  JVS(120) = B(17)+2*B(135)+0.69*B(137)
! JVS(121) = Jac_FULL(28,33)
  JVS(121) = 0.59*B(155)
! JVS(122) = Jac_FULL(28,34)
  JVS(122) = 0.31*B(111)
! JVS(123) = Jac_FULL(28,35)
  JVS(123) = 0.07*B(141)
! JVS(124) = Jac_FULL(28,36)
  JVS(124) = B(10)+B(11)+B(93)+B(95)
! JVS(125) = Jac_FULL(28,39)
  JVS(125) = 0.3*B(113)
! JVS(126) = Jac_FULL(28,42)
  JVS(126) = B(16)+B(105)
! JVS(127) = Jac_FULL(28,43)
  JVS(127) = B(14)
! JVS(128) = Jac_FULL(28,45)
  JVS(128) = 0.33*B(20)+0.16*B(147)+0.64*B(149)
! JVS(129) = Jac_FULL(28,50)
  JVS(129) = -B(84)+B(94)+2*B(136)
! JVS(130) = Jac_FULL(28,51)
  JVS(130) = 0.24*B(108)+0.31*B(112)+0.3*B(114)+0.69*B(138)+0.07*B(142)+0.16*B(148)
! JVS(131) = Jac_FULL(28,54)
  JVS(131) = B(96)+B(106)+0.64*B(150)
! JVS(132) = Jac_FULL(28,56)
  JVS(132) = 0.59*B(156)
! JVS(133) = Jac_FULL(29,13)
  JVS(133) = 1.1*B(125)
! JVS(134) = Jac_FULL(29,19)
  JVS(134) = -B(220)
! JVS(135) = Jac_FULL(29,29)
  JVS(135) = -B(91)-B(221)
! JVS(136) = Jac_FULL(29,31)
  JVS(136) = 1.6*B(153)+2*B(159)+2*B(232)
! JVS(137) = Jac_FULL(29,32)
  JVS(137) = 0.18*B(151)
! JVS(138) = Jac_FULL(29,34)
  JVS(138) = 0
! JVS(139) = Jac_FULL(29,39)
  JVS(139) = 0
! JVS(140) = Jac_FULL(29,41)
  JVS(140) = 0
! JVS(141) = Jac_FULL(29,45)
  JVS(141) = 1.86*B(149)
! JVS(142) = Jac_FULL(29,47)
  JVS(142) = 0
! JVS(143) = Jac_FULL(29,48)
  JVS(143) = 0
! JVS(144) = Jac_FULL(29,49)
  JVS(144) = 0
! JVS(145) = Jac_FULL(29,50)
  JVS(145) = -B(92)+1.1*B(126)
! JVS(146) = Jac_FULL(29,51)
  JVS(146) = 0
! JVS(147) = Jac_FULL(29,54)
  JVS(147) = 1.86*B(150)
! JVS(148) = Jac_FULL(29,55)
  JVS(148) = 2*B(160)
! JVS(149) = Jac_FULL(29,56)
  JVS(149) = 0.18*B(152)+1.6*B(154)
! JVS(150) = Jac_FULL(30,18)
  JVS(150) = 0.95*B(127)
! JVS(151) = Jac_FULL(30,26)
  JVS(151) = 0.3*B(129)
! JVS(152) = Jac_FULL(30,30)
  JVS(152) = -B(17)-B(135)-B(137)
! JVS(153) = Jac_FULL(30,50)
  JVS(153) = 0.3*B(130)-B(136)
! JVS(154) = Jac_FULL(30,51)
  JVS(154) = -B(138)
! JVS(155) = Jac_FULL(30,54)
  JVS(155) = 0
! JVS(156) = Jac_FULL(30,56)
  JVS(156) = 0.95*B(128)
! JVS(157) = Jac_FULL(31,31)
  JVS(157) = -B(153)-B(159)-B(232)
! JVS(158) = Jac_FULL(31,35)
  JVS(158) = B(143)
! JVS(159) = Jac_FULL(31,54)
  JVS(159) = B(144)
! JVS(160) = Jac_FULL(31,55)
  JVS(160) = -B(160)
! JVS(161) = Jac_FULL(31,56)
  JVS(161) = -B(154)
! JVS(162) = Jac_FULL(32,32)
  JVS(162) = -B(151)-B(157)-B(231)
! JVS(163) = Jac_FULL(32,35)
  JVS(163) = B(139)
! JVS(164) = Jac_FULL(32,50)
  JVS(164) = B(140)
! JVS(165) = Jac_FULL(32,55)
  JVS(165) = -B(158)
! JVS(166) = Jac_FULL(32,56)
  JVS(166) = -B(152)
! JVS(167) = Jac_FULL(33,33)
  JVS(167) = -B(155)-B(161)-B(233)
! JVS(168) = Jac_FULL(33,45)
  JVS(168) = 0.5*B(145)
! JVS(169) = Jac_FULL(33,50)
  JVS(169) = 0.5*B(146)
! JVS(170) = Jac_FULL(33,55)
  JVS(170) = -B(162)
! JVS(171) = Jac_FULL(33,56)
  JVS(171) = -B(156)
! JVS(172) = Jac_FULL(34,34)
  JVS(172) = -B(111)-B(115)-B(119)
! JVS(173) = Jac_FULL(34,50)
  JVS(173) = -B(116)
! JVS(174) = Jac_FULL(34,51)
  JVS(174) = -B(112)
! JVS(175) = Jac_FULL(34,54)
  JVS(175) = -B(120)
! JVS(176) = Jac_FULL(35,35)
  JVS(176) = -B(139)-B(141)-B(143)
! JVS(177) = Jac_FULL(35,50)
  JVS(177) = -B(140)
! JVS(178) = Jac_FULL(35,51)
  JVS(178) = -B(142)
! JVS(179) = Jac_FULL(35,54)
  JVS(179) = -B(144)
! JVS(180) = Jac_FULL(36,20)
  JVS(180) = B(12)+0.3*B(163)
! JVS(181) = Jac_FULL(36,23)
  JVS(181) = B(107)+1.56*B(109)
! JVS(182) = Jac_FULL(36,24)
  JVS(182) = B(174)
! JVS(183) = Jac_FULL(36,30)
  JVS(183) = B(135)+0.7*B(137)
! JVS(184) = Jac_FULL(36,32)
  JVS(184) = 0.63*B(151)
! JVS(185) = Jac_FULL(36,33)
  JVS(185) = 0.25*B(155)
! JVS(186) = Jac_FULL(36,34)
  JVS(186) = 0.57*B(111)+B(115)
! JVS(187) = Jac_FULL(36,35)
  JVS(187) = 0.6*B(141)
! JVS(188) = Jac_FULL(36,36)
  JVS(188) = -B(10)-B(11)-B(93)-B(95)
! JVS(189) = Jac_FULL(36,39)
  JVS(189) = 0
! JVS(190) = Jac_FULL(36,41)
  JVS(190) = 0.5*B(186)+0.5*B(200)+0.5*B(230)
! JVS(191) = Jac_FULL(36,44)
  JVS(191) = B(176)+B(190)+0.66*B(225)
! JVS(192) = Jac_FULL(36,45)
  JVS(192) = 0.2*B(20)+0.15*B(147)+0.28*B(149)
! JVS(193) = Jac_FULL(36,46)
  JVS(193) = B(184)+B(198)+0.7*B(229)
! JVS(194) = Jac_FULL(36,50)
  JVS(194) = -B(94)+1.56*B(110)+B(116)+B(136)+0.3*B(164)+B(175)
! JVS(195) = Jac_FULL(36,51)
  JVS(195) = B(108)+0.57*B(112)+0.7*B(138)+0.6*B(142)+0.15*B(148)
! JVS(196) = Jac_FULL(36,54)
  JVS(196) = -B(96)+0.28*B(150)+B(191)+B(199)+0.5*B(201)
! JVS(197) = Jac_FULL(36,55)
  JVS(197) = 0
! JVS(198) = Jac_FULL(36,56)
  JVS(198) = 0.63*B(152)+0.25*B(156)+B(177)+B(185)+0.5*B(187)
! JVS(199) = Jac_FULL(37,11)
  JVS(199) = 0.08*B(123)
! JVS(200) = Jac_FULL(37,13)
  JVS(200) = 0.5*B(125)
! JVS(201) = Jac_FULL(37,23)
  JVS(201) = B(109)
! JVS(202) = Jac_FULL(37,26)
  JVS(202) = 0.6*B(129)
! JVS(203) = Jac_FULL(37,30)
  JVS(203) = B(135)+0.03*B(137)
! JVS(204) = Jac_FULL(37,34)
  JVS(204) = B(115)
! JVS(205) = Jac_FULL(37,35)
  JVS(205) = 0.08*B(139)+0.2*B(141)
! JVS(206) = Jac_FULL(37,37)
  JVS(206) = -B(188)-B(202)-B(216)-B(234)
! JVS(207) = Jac_FULL(37,39)
  JVS(207) = B(117)
! JVS(208) = Jac_FULL(37,42)
  JVS(208) = B(103)
! JVS(209) = Jac_FULL(37,45)
  JVS(209) = 0.2*B(145)+0.07*B(147)+0.93*B(149)
! JVS(210) = Jac_FULL(37,47)
  JVS(210) = 0.4*B(18)
! JVS(211) = Jac_FULL(37,48)
  JVS(211) = 0.34*B(180)+0.4*B(194)+0.24*B(227)
! JVS(212) = Jac_FULL(37,49)
  JVS(212) = 0.41*B(19)
! JVS(213) = Jac_FULL(37,50)
  JVS(213) = B(104)+B(110)+B(116)+B(118)+0.08*B(124)+0.5*B(126)+0.6*B(130)+B(136)+0.08*B(140)+0.2*B(146)
! JVS(214) = Jac_FULL(37,51)
  JVS(214) = 0.03*B(138)+0.2*B(142)+0.07*B(148)
! JVS(215) = Jac_FULL(37,54)
  JVS(215) = 0.93*B(150)+0.4*B(195)-B(203)
! JVS(216) = Jac_FULL(37,55)
  JVS(216) = -B(217)
! JVS(217) = Jac_FULL(37,56)
  JVS(217) = 0.34*B(181)-B(189)
! JVS(218) = Jac_FULL(38,33)
  JVS(218) = 0.63*B(155)+0.5*B(233)
! JVS(219) = Jac_FULL(38,38)
  JVS(219) = -B(15)-B(101)
! JVS(220) = Jac_FULL(38,39)
  JVS(220) = 0.07*B(113)+0.23*B(117)
! JVS(221) = Jac_FULL(38,45)
  JVS(221) = 0.03*B(20)+0.09*B(147)
! JVS(222) = Jac_FULL(38,46)
  JVS(222) = 0.15*B(229)
! JVS(223) = Jac_FULL(38,47)
  JVS(223) = 0.74*B(18)
! JVS(224) = Jac_FULL(38,48)
  JVS(224) = 0.62*B(180)+0.74*B(194)+0.57*B(227)
! JVS(225) = Jac_FULL(38,49)
  JVS(225) = 0.74*B(19)
! JVS(226) = Jac_FULL(38,50)
  JVS(226) = -B(102)+0.23*B(118)
! JVS(227) = Jac_FULL(38,51)
  JVS(227) = 0.07*B(114)+0.09*B(148)
! JVS(228) = Jac_FULL(38,54)
  JVS(228) = 0.74*B(195)
! JVS(229) = Jac_FULL(38,55)
  JVS(229) = 0
! JVS(230) = Jac_FULL(38,56)
  JVS(230) = 0.63*B(156)+0.62*B(181)
! JVS(231) = Jac_FULL(39,39)
  JVS(231) = -B(113)-B(117)-B(121)
! JVS(232) = Jac_FULL(39,50)
  JVS(232) = -B(118)
! JVS(233) = Jac_FULL(39,51)
  JVS(233) = -B(114)
! JVS(234) = Jac_FULL(39,54)
  JVS(234) = -B(122)
! JVS(235) = Jac_FULL(40,17)
  JVS(235) = B(89)
! JVS(236) = Jac_FULL(40,21)
  JVS(236) = 0.7*B(165)
! JVS(237) = Jac_FULL(40,34)
  JVS(237) = 0.06*B(111)
! JVS(238) = Jac_FULL(40,39)
  JVS(238) = 0.05*B(113)
! JVS(239) = Jac_FULL(40,40)
  JVS(239) = -B(178)-B(192)-B(206)-B(226)
! JVS(240) = Jac_FULL(40,47)
  JVS(240) = 0.1*B(18)
! JVS(241) = Jac_FULL(40,48)
  JVS(241) = 0.08*B(180)+0.1*B(194)+0.06*B(227)
! JVS(242) = Jac_FULL(40,49)
  JVS(242) = 0.1*B(19)
! JVS(243) = Jac_FULL(40,50)
  JVS(243) = B(90)+0.7*B(166)
! JVS(244) = Jac_FULL(40,51)
  JVS(244) = 0.06*B(112)+0.05*B(114)
! JVS(245) = Jac_FULL(40,54)
  JVS(245) = -B(193)+0.1*B(195)
! JVS(246) = Jac_FULL(40,55)
  JVS(246) = -B(207)
! JVS(247) = Jac_FULL(40,56)
  JVS(247) = -B(179)+0.08*B(181)
! JVS(248) = Jac_FULL(41,34)
  JVS(248) = B(119)
! JVS(249) = Jac_FULL(41,39)
  JVS(249) = B(121)
! JVS(250) = Jac_FULL(41,41)
  JVS(250) = -B(186)-B(200)-B(214)-B(230)
! JVS(251) = Jac_FULL(41,49)
  JVS(251) = B(169)
! JVS(252) = Jac_FULL(41,50)
  JVS(252) = B(170)
! JVS(253) = Jac_FULL(41,51)
  JVS(253) = 0
! JVS(254) = Jac_FULL(41,54)
  JVS(254) = B(120)+B(122)-B(201)
! JVS(255) = Jac_FULL(41,55)
  JVS(255) = -B(215)
! JVS(256) = Jac_FULL(41,56)
  JVS(256) = -B(187)
! JVS(257) = Jac_FULL(42,13)
  JVS(257) = 0.8*B(125)
! JVS(258) = Jac_FULL(42,30)
  JVS(258) = 0.2*B(137)
! JVS(259) = Jac_FULL(42,33)
  JVS(259) = 0.34*B(155)
! JVS(260) = Jac_FULL(42,34)
  JVS(260) = 0.04*B(111)
! JVS(261) = Jac_FULL(42,39)
  JVS(261) = 0.07*B(113)
! JVS(262) = Jac_FULL(42,42)
  JVS(262) = -B(16)-B(103)-B(105)
! JVS(263) = Jac_FULL(42,45)
  JVS(263) = 0.85*B(147)
! JVS(264) = Jac_FULL(42,46)
  JVS(264) = 0.15*B(229)
! JVS(265) = Jac_FULL(42,47)
  JVS(265) = 0.19*B(167)
! JVS(266) = Jac_FULL(42,50)
  JVS(266) = -B(104)+0.8*B(126)+0.19*B(168)
! JVS(267) = Jac_FULL(42,51)
  JVS(267) = 0.04*B(112)+0.07*B(114)+0.2*B(138)+0.85*B(148)
! JVS(268) = Jac_FULL(42,54)
  JVS(268) = -B(106)
! JVS(269) = Jac_FULL(42,55)
  JVS(269) = 0
! JVS(270) = Jac_FULL(42,56)
  JVS(270) = 0.34*B(156)
! JVS(271) = Jac_FULL(43,8)
  JVS(271) = B(218)
! JVS(272) = Jac_FULL(43,21)
  JVS(272) = B(13)+0.3*B(165)
! JVS(273) = Jac_FULL(43,23)
  JVS(273) = 0.22*B(109)
! JVS(274) = Jac_FULL(43,30)
  JVS(274) = 0.03*B(137)
! JVS(275) = Jac_FULL(43,31)
  JVS(275) = 0.8*B(153)+B(232)
! JVS(276) = Jac_FULL(43,33)
  JVS(276) = 0.55*B(155)+0.5*B(233)
! JVS(277) = Jac_FULL(43,34)
  JVS(277) = 0.47*B(111)+B(115)
! JVS(278) = Jac_FULL(43,35)
  JVS(278) = 0.15*B(141)
! JVS(279) = Jac_FULL(43,39)
  JVS(279) = 1.03*B(113)+1.77*B(117)
! JVS(280) = Jac_FULL(43,40)
  JVS(280) = B(178)+B(192)+0.8*B(226)
! JVS(281) = Jac_FULL(43,41)
  JVS(281) = 0.5*B(186)+0.5*B(200)+0.5*B(230)
! JVS(282) = Jac_FULL(43,43)
  JVS(282) = -B(14)-B(97)-B(99)
! JVS(283) = Jac_FULL(43,45)
  JVS(283) = 0.07*B(20)+0.02*B(147)+0.28*B(149)
! JVS(284) = Jac_FULL(43,47)
  JVS(284) = 0.3*B(18)+0.04*B(167)
! JVS(285) = Jac_FULL(43,48)
  JVS(285) = 0.25*B(180)+0.3*B(194)+0.21*B(227)
! JVS(286) = Jac_FULL(43,49)
  JVS(286) = 0.3*B(19)
! JVS(287) = Jac_FULL(43,50)
  JVS(287) = -B(98)+0.22*B(110)+B(116)+1.77*B(118)+0.3*B(166)+0.04*B(168)+B(219)
! JVS(288) = Jac_FULL(43,51)
  JVS(288) = 0.47*B(112)+1.03*B(114)+0.03*B(138)+0.15*B(142)+0.02*B(148)
! JVS(289) = Jac_FULL(43,54)
  JVS(289) = -B(100)+0.28*B(150)+B(193)+0.3*B(195)+0.5*B(201)
! JVS(290) = Jac_FULL(43,55)
  JVS(290) = 0
! JVS(291) = Jac_FULL(43,56)
  JVS(291) = 0.8*B(154)+0.55*B(156)+B(179)+0.25*B(181)+0.5*B(187)
! JVS(292) = Jac_FULL(44,14)
  JVS(292) = B(87)
! JVS(293) = Jac_FULL(44,20)
  JVS(293) = 0.7*B(163)
! JVS(294) = Jac_FULL(44,34)
  JVS(294) = 0.07*B(111)
! JVS(295) = Jac_FULL(44,38)
  JVS(295) = B(15)
! JVS(296) = Jac_FULL(44,39)
  JVS(296) = 0.1*B(113)
! JVS(297) = Jac_FULL(44,43)
  JVS(297) = B(14)
! JVS(298) = Jac_FULL(44,44)
  JVS(298) = -B(176)-B(190)-B(204)-B(225)
! JVS(299) = Jac_FULL(44,45)
  JVS(299) = 0.7*B(20)+0.05*B(147)
! JVS(300) = Jac_FULL(44,46)
  JVS(300) = 0
! JVS(301) = Jac_FULL(44,47)
  JVS(301) = 0
! JVS(302) = Jac_FULL(44,48)
  JVS(302) = 0
! JVS(303) = Jac_FULL(44,49)
  JVS(303) = 0
! JVS(304) = Jac_FULL(44,50)
  JVS(304) = B(88)+0.7*B(164)
! JVS(305) = Jac_FULL(44,51)
  JVS(305) = 0.07*B(112)+0.1*B(114)+0.05*B(148)
! JVS(306) = Jac_FULL(44,53)
  JVS(306) = B(182)+B(196)+B(228)
! JVS(307) = Jac_FULL(44,54)
  JVS(307) = -B(191)+B(197)
! JVS(308) = Jac_FULL(44,55)
  JVS(308) = -B(205)
! JVS(309) = Jac_FULL(44,56)
  JVS(309) = -B(177)+B(183)
! JVS(310) = Jac_FULL(45,31)
  JVS(310) = 0.2*B(153)
! JVS(311) = Jac_FULL(45,32)
  JVS(311) = 0.91*B(151)+B(231)
! JVS(312) = Jac_FULL(45,35)
  JVS(312) = 0.65*B(141)
! JVS(313) = Jac_FULL(45,45)
  JVS(313) = -B(20)-B(145)-B(147)-B(149)
! JVS(314) = Jac_FULL(45,50)
  JVS(314) = -B(146)
! JVS(315) = Jac_FULL(45,51)
  JVS(315) = 0.65*B(142)-B(148)
! JVS(316) = Jac_FULL(45,54)
  JVS(316) = -B(150)
! JVS(317) = Jac_FULL(45,55)
  JVS(317) = 0
! JVS(318) = Jac_FULL(45,56)
  JVS(318) = 0.91*B(152)+0.2*B(154)
! JVS(319) = Jac_FULL(46,38)
  JVS(319) = B(101)
! JVS(320) = Jac_FULL(46,39)
  JVS(320) = 0.11*B(113)
! JVS(321) = Jac_FULL(46,45)
  JVS(321) = 0
! JVS(322) = Jac_FULL(46,46)
  JVS(322) = -B(184)-B(198)-B(212)-B(229)
! JVS(323) = Jac_FULL(46,47)
  JVS(323) = 0
! JVS(324) = Jac_FULL(46,48)
  JVS(324) = 0
! JVS(325) = Jac_FULL(46,49)
  JVS(325) = 0
! JVS(326) = Jac_FULL(46,50)
  JVS(326) = B(102)
! JVS(327) = Jac_FULL(46,51)
  JVS(327) = 0.11*B(114)
! JVS(328) = Jac_FULL(46,54)
  JVS(328) = -B(199)
! JVS(329) = Jac_FULL(46,55)
  JVS(329) = -B(213)
! JVS(330) = Jac_FULL(46,56)
  JVS(330) = -B(185)
! JVS(331) = Jac_FULL(47,32)
  JVS(331) = B(157)
! JVS(332) = Jac_FULL(47,33)
  JVS(332) = B(161)
! JVS(333) = Jac_FULL(47,35)
  JVS(333) = 0
! JVS(334) = Jac_FULL(47,45)
  JVS(334) = 0
! JVS(335) = Jac_FULL(47,46)
  JVS(335) = B(212)
! JVS(336) = Jac_FULL(47,47)
  JVS(336) = -B(18)-B(167)
! JVS(337) = Jac_FULL(47,48)
  JVS(337) = B(208)
! JVS(338) = Jac_FULL(47,49)
  JVS(338) = 0
! JVS(339) = Jac_FULL(47,50)
  JVS(339) = -B(168)
! JVS(340) = Jac_FULL(47,51)
  JVS(340) = 0
! JVS(341) = Jac_FULL(47,54)
  JVS(341) = 0
! JVS(342) = Jac_FULL(47,55)
  JVS(342) = B(158)+B(162)+B(209)+B(213)
! JVS(343) = Jac_FULL(47,56)
  JVS(343) = 0
! JVS(344) = Jac_FULL(48,29)
  JVS(344) = B(91)
! JVS(345) = Jac_FULL(48,31)
  JVS(345) = 0
! JVS(346) = Jac_FULL(48,32)
  JVS(346) = 0
! JVS(347) = Jac_FULL(48,34)
  JVS(347) = 0.03*B(111)
! JVS(348) = Jac_FULL(48,35)
  JVS(348) = 0
! JVS(349) = Jac_FULL(48,39)
  JVS(349) = 0.09*B(113)
! JVS(350) = Jac_FULL(48,41)
  JVS(350) = 0
! JVS(351) = Jac_FULL(48,45)
  JVS(351) = 0
! JVS(352) = Jac_FULL(48,47)
  JVS(352) = 0.77*B(167)
! JVS(353) = Jac_FULL(48,48)
  JVS(353) = -B(180)-B(194)-B(208)-B(227)
! JVS(354) = Jac_FULL(48,49)
  JVS(354) = 0
! JVS(355) = Jac_FULL(48,50)
  JVS(355) = B(92)+0.77*B(168)
! JVS(356) = Jac_FULL(48,51)
  JVS(356) = 0.03*B(112)+0.09*B(114)
! JVS(357) = Jac_FULL(48,54)
  JVS(357) = -B(195)
! JVS(358) = Jac_FULL(48,55)
  JVS(358) = -B(209)
! JVS(359) = Jac_FULL(48,56)
  JVS(359) = -B(181)
! JVS(360) = Jac_FULL(49,15)
  JVS(360) = B(133)
! JVS(361) = Jac_FULL(49,18)
  JVS(361) = 0.05*B(127)
! JVS(362) = Jac_FULL(49,26)
  JVS(362) = 0
! JVS(363) = Jac_FULL(49,31)
  JVS(363) = 0.8*B(153)+B(159)+B(232)
! JVS(364) = Jac_FULL(49,32)
  JVS(364) = 0.09*B(151)
! JVS(365) = Jac_FULL(49,35)
  JVS(365) = 0
! JVS(366) = Jac_FULL(49,41)
  JVS(366) = 0.5*B(186)+0.5*B(200)+B(214)+0.5*B(230)
! JVS(367) = Jac_FULL(49,45)
  JVS(367) = 0.93*B(149)
! JVS(368) = Jac_FULL(49,48)
  JVS(368) = 0.16*B(180)
! JVS(369) = Jac_FULL(49,49)
  JVS(369) = -B(19)-B(169)
! JVS(370) = Jac_FULL(49,50)
  JVS(370) = -B(170)
! JVS(371) = Jac_FULL(49,51)
  JVS(371) = 0
! JVS(372) = Jac_FULL(49,52)
  JVS(372) = B(134)
! JVS(373) = Jac_FULL(49,54)
  JVS(373) = 0.93*B(150)+0.5*B(201)
! JVS(374) = Jac_FULL(49,55)
  JVS(374) = B(160)+B(215)
! JVS(375) = Jac_FULL(49,56)
  JVS(375) = 0.05*B(128)+0.09*B(152)+0.8*B(154)+0.16*B(181)+0.5*B(187)
! JVS(376) = Jac_FULL(50,6)
  JVS(376) = 2*B(23)
! JVS(377) = Jac_FULL(50,7)
  JVS(377) = -B(85)
! JVS(378) = Jac_FULL(50,8)
  JVS(378) = -B(218)
! JVS(379) = Jac_FULL(50,9)
  JVS(379) = 2*B(9)-B(59)
! JVS(380) = Jac_FULL(50,11)
  JVS(380) = -B(123)
! JVS(381) = Jac_FULL(50,13)
  JVS(381) = -B(125)
! JVS(382) = Jac_FULL(50,14)
  JVS(382) = -B(87)
! JVS(383) = Jac_FULL(50,16)
  JVS(383) = -B(55)
! JVS(384) = Jac_FULL(50,17)
  JVS(384) = -B(89)
! JVS(385) = Jac_FULL(50,20)
  JVS(385) = B(12)-0.7*B(163)
! JVS(386) = Jac_FULL(50,21)
  JVS(386) = B(13)-0.7*B(165)
! JVS(387) = Jac_FULL(50,22)
  JVS(387) = B(3)-B(51)
! JVS(388) = Jac_FULL(50,23)
  JVS(388) = 0.12*B(107)-B(109)
! JVS(389) = Jac_FULL(50,24)
  JVS(389) = -B(174)
! JVS(390) = Jac_FULL(50,26)
  JVS(390) = -B(129)
! JVS(391) = Jac_FULL(50,27)
  JVS(391) = B(4)-B(53)
! JVS(392) = Jac_FULL(50,28)
  JVS(392) = -B(83)
! JVS(393) = Jac_FULL(50,29)
  JVS(393) = -B(91)
! JVS(394) = Jac_FULL(50,30)
  JVS(394) = -B(135)+0.08*B(137)
! JVS(395) = Jac_FULL(50,31)
  JVS(395) = 0
! JVS(396) = Jac_FULL(50,32)
  JVS(396) = 0
! JVS(397) = Jac_FULL(50,33)
  JVS(397) = 0
! JVS(398) = Jac_FULL(50,34)
  JVS(398) = 0.33*B(111)-B(115)
! JVS(399) = Jac_FULL(50,35)
  JVS(399) = -B(139)+0.27*B(141)
! JVS(400) = Jac_FULL(50,36)
  JVS(400) = -B(93)
! JVS(401) = Jac_FULL(50,38)
  JVS(401) = -B(101)
! JVS(402) = Jac_FULL(50,39)
  JVS(402) = 0.6*B(113)-B(117)
! JVS(403) = Jac_FULL(50,40)
  JVS(403) = 0
! JVS(404) = Jac_FULL(50,41)
  JVS(404) = 0
! JVS(405) = Jac_FULL(50,42)
  JVS(405) = -B(103)
! JVS(406) = Jac_FULL(50,43)
  JVS(406) = -B(97)
! JVS(407) = Jac_FULL(50,44)
  JVS(407) = 0
! JVS(408) = Jac_FULL(50,45)
  JVS(408) = -B(145)+0.27*B(147)
! JVS(409) = Jac_FULL(50,46)
  JVS(409) = 0
! JVS(410) = Jac_FULL(50,47)
  JVS(410) = B(18)-0.77*B(167)
! JVS(411) = Jac_FULL(50,48)
  JVS(411) = 0
! JVS(412) = Jac_FULL(50,49)
  JVS(412) = -B(169)
! JVS(413) = Jac_FULL(50,50)
...
! JVS(414) = Jac_FULL(50,51)
  JVS(414) = -B(40)+B(41)+0.12*B(108)+0.33*B(112)+0.6*B(114)+0.08*B(138)+0.27*B(142)+0.27*B(148)
! JVS(415) = Jac_FULL(50,52)
  JVS(415) = -B(48)
! JVS(416) = Jac_FULL(50,53)
  JVS(416) = 0
! JVS(417) = Jac_FULL(50,54)
  JVS(417) = -B(50)+0.7*B(78)
! JVS(418) = Jac_FULL(50,55)
  JVS(418) = B(42)-B(58)+B(64)+0.7*B(79)
! JVS(419) = Jac_FULL(50,56)
  JVS(419) = -B(46)+B(65)
! JVS(420) = Jac_FULL(51,23)
  JVS(420) = -B(107)
! JVS(421) = Jac_FULL(51,25)
  JVS(421) = B(25)-B(27)
! JVS(422) = Jac_FULL(51,30)
  JVS(422) = -B(137)
! JVS(423) = Jac_FULL(51,34)
  JVS(423) = -B(111)
! JVS(424) = Jac_FULL(51,35)
  JVS(424) = -B(141)
! JVS(425) = Jac_FULL(51,39)
  JVS(425) = -B(113)
! JVS(426) = Jac_FULL(51,45)
  JVS(426) = -B(147)
! JVS(427) = Jac_FULL(51,50)
  JVS(427) = -B(39)
! JVS(428) = Jac_FULL(51,51)
  JVS(428) = -B(7)-B(8)-B(28)-B(35)-B(37)-B(40)-B(41)-B(108)-B(112)-B(114)-B(138)-B(142)-B(148)
! JVS(429) = Jac_FULL(51,52)
  JVS(429) = -B(38)
! JVS(430) = Jac_FULL(51,53)
  JVS(430) = 0.4*B(210)
! JVS(431) = Jac_FULL(51,54)
  JVS(431) = 0
! JVS(432) = Jac_FULL(51,55)
  JVS(432) = -B(42)+0.4*B(211)
! JVS(433) = Jac_FULL(51,56)
  JVS(433) = -B(36)
! JVS(434) = Jac_FULL(52,10)
  JVS(434) = B(173)
! JVS(435) = Jac_FULL(52,12)
  JVS(435) = B(6)+B(82)
! JVS(436) = Jac_FULL(52,15)
  JVS(436) = -B(133)
! JVS(437) = Jac_FULL(52,16)
  JVS(437) = B(5)+B(55)+B(70)
! JVS(438) = Jac_FULL(52,18)
  JVS(438) = 0.95*B(127)
! JVS(439) = Jac_FULL(52,22)
  JVS(439) = B(51)
! JVS(440) = Jac_FULL(52,25)
  JVS(440) = -B(29)-B(31)+B(33)
! JVS(441) = Jac_FULL(52,26)
  JVS(441) = 0
! JVS(442) = Jac_FULL(52,27)
  JVS(442) = B(4)
! JVS(443) = Jac_FULL(52,31)
  JVS(443) = 1.2*B(153)
! JVS(444) = Jac_FULL(52,32)
  JVS(444) = 0.91*B(151)
! JVS(445) = Jac_FULL(52,33)
  JVS(445) = B(155)
! JVS(446) = Jac_FULL(52,35)
  JVS(446) = 0
! JVS(447) = Jac_FULL(52,36)
  JVS(447) = 0
! JVS(448) = Jac_FULL(52,37)
  JVS(448) = B(188)+B(202)
! JVS(449) = Jac_FULL(52,39)
  JVS(449) = 0
! JVS(450) = Jac_FULL(52,40)
  JVS(450) = B(178)+B(192)
! JVS(451) = Jac_FULL(52,41)
  JVS(451) = 1.5*B(186)+1.5*B(200)+0.5*B(230)
! JVS(452) = Jac_FULL(52,42)
  JVS(452) = 0
! JVS(453) = Jac_FULL(52,43)
  JVS(453) = 0
! JVS(454) = Jac_FULL(52,44)
  JVS(454) = B(176)+B(190)
! JVS(455) = Jac_FULL(52,45)
  JVS(455) = 0
! JVS(456) = Jac_FULL(52,46)
  JVS(456) = B(184)+B(198)
! JVS(457) = Jac_FULL(52,47)
  JVS(457) = 0
! JVS(458) = Jac_FULL(52,48)
  JVS(458) = 0.84*B(180)+B(194)
! JVS(459) = Jac_FULL(52,49)
  JVS(459) = B(19)
! JVS(460) = Jac_FULL(52,50)
  JVS(460) = -B(47)+B(49)+B(52)+B(56)
! JVS(461) = Jac_FULL(52,51)
  JVS(461) = B(35)-B(37)
! JVS(462) = Jac_FULL(52,52)
  JVS(462) = -B(1)-B(30)-B(32)-B(38)-B(48)-B(66)-B(68)-B(75)-B(134)-B(171)
! JVS(463) = Jac_FULL(52,53)
  JVS(463) = -B(172)+B(182)+B(196)
! JVS(464) = Jac_FULL(52,54)
  JVS(464) = 0.89*B(2)+B(50)+2*B(71)-B(76)+2*B(77)+0.7*B(78)+B(191)+B(193)+B(195)+B(197)+B(199)+1.5*B(201)+B(203)
! JVS(465) = Jac_FULL(52,55)
  JVS(465) = B(64)-B(67)-B(69)+0.7*B(79)
! JVS(466) = Jac_FULL(52,56)
  JVS(466) = B(34)+B(36)+B(65)+2*B(72)+0.95*B(128)+0.91*B(152)+1.2*B(154)+B(156)+B(177)+B(179)+0.84*B(181)+B(183)+B(185)&
               &+1.5*B(187)+B(189)
! JVS(467) = Jac_FULL(53,10)
  JVS(467) = B(173)
! JVS(468) = Jac_FULL(53,30)
  JVS(468) = B(17)+B(135)+0.62*B(137)
! JVS(469) = Jac_FULL(53,34)
  JVS(469) = 0.13*B(111)
! JVS(470) = Jac_FULL(53,35)
  JVS(470) = 0.2*B(141)
! JVS(471) = Jac_FULL(53,38)
  JVS(471) = B(15)
! JVS(472) = Jac_FULL(53,39)
  JVS(472) = 0.19*B(113)
! JVS(473) = Jac_FULL(53,42)
  JVS(473) = B(16)+B(103)+B(105)
! JVS(474) = Jac_FULL(53,43)
  JVS(474) = B(97)+B(99)
! JVS(475) = Jac_FULL(53,45)
  JVS(475) = 0.97*B(20)+0.5*B(145)+0.11*B(147)+0.07*B(149)
! JVS(476) = Jac_FULL(53,46)
  JVS(476) = B(184)+B(198)+0.7*B(229)
! JVS(477) = Jac_FULL(53,47)
  JVS(477) = 0
! JVS(478) = Jac_FULL(53,48)
  JVS(478) = 0
! JVS(479) = Jac_FULL(53,49)
  JVS(479) = 0
! JVS(480) = Jac_FULL(53,50)
  JVS(480) = B(98)+B(104)+B(136)+0.5*B(146)
! JVS(481) = Jac_FULL(53,51)
  JVS(481) = 0.13*B(112)+0.19*B(114)+0.62*B(138)+0.2*B(142)+0.11*B(148)
! JVS(482) = Jac_FULL(53,52)
  JVS(482) = -B(171)
! JVS(483) = Jac_FULL(53,53)
  JVS(483) = -B(172)-B(182)-B(196)-B(210)-B(228)
! JVS(484) = Jac_FULL(53,54)
  JVS(484) = B(100)+B(106)+0.07*B(150)-B(197)+B(199)
! JVS(485) = Jac_FULL(53,55)
  JVS(485) = -B(211)
! JVS(486) = Jac_FULL(53,56)
  JVS(486) = -B(183)+B(185)
! JVS(487) = Jac_FULL(54,12)
  JVS(487) = B(6)+B(82)
! JVS(488) = Jac_FULL(54,25)
  JVS(488) = B(31)
! JVS(489) = Jac_FULL(54,26)
  JVS(489) = -B(131)
! JVS(490) = Jac_FULL(54,27)
  JVS(490) = B(53)
! JVS(491) = Jac_FULL(54,34)
  JVS(491) = -B(119)
! JVS(492) = Jac_FULL(54,35)
  JVS(492) = -B(143)
! JVS(493) = Jac_FULL(54,36)
  JVS(493) = -B(95)
! JVS(494) = Jac_FULL(54,37)
  JVS(494) = -B(202)
! JVS(495) = Jac_FULL(54,39)
  JVS(495) = -B(121)
! JVS(496) = Jac_FULL(54,40)
  JVS(496) = -B(192)
! JVS(497) = Jac_FULL(54,41)
  JVS(497) = -B(200)
! JVS(498) = Jac_FULL(54,42)
  JVS(498) = -B(105)
! JVS(499) = Jac_FULL(54,43)
  JVS(499) = -B(99)
! JVS(500) = Jac_FULL(54,44)
  JVS(500) = -B(190)
! JVS(501) = Jac_FULL(54,45)
  JVS(501) = -B(149)
! JVS(502) = Jac_FULL(54,46)
  JVS(502) = -B(198)
! JVS(503) = Jac_FULL(54,47)
  JVS(503) = 0
! JVS(504) = Jac_FULL(54,48)
  JVS(504) = -B(194)
! JVS(505) = Jac_FULL(54,49)
  JVS(505) = 0
! JVS(506) = Jac_FULL(54,50)
  JVS(506) = -B(49)+B(54)
! JVS(507) = Jac_FULL(54,51)
  JVS(507) = B(37)
! JVS(508) = Jac_FULL(54,52)
  JVS(508) = B(32)+B(38)-B(73)-B(75)
! JVS(509) = Jac_FULL(54,53)
  JVS(509) = -B(196)
! JVS(510) = Jac_FULL(54,54)
...
! JVS(511) = Jac_FULL(54,55)
  JVS(511) = -B(79)
! JVS(512) = Jac_FULL(54,56)
  JVS(512) = -B(72)
! JVS(513) = Jac_FULL(55,7)
  JVS(513) = B(85)
! JVS(514) = Jac_FULL(55,8)
  JVS(514) = B(218)
! JVS(515) = Jac_FULL(55,9)
  JVS(515) = B(59)
! JVS(516) = Jac_FULL(55,11)
  JVS(516) = 0.2*B(123)
! JVS(517) = Jac_FULL(55,13)
  JVS(517) = 0.55*B(125)
! JVS(518) = Jac_FULL(55,16)
  JVS(518) = B(5)+B(70)
! JVS(519) = Jac_FULL(55,18)
  JVS(519) = 0.95*B(127)
! JVS(520) = Jac_FULL(55,20)
  JVS(520) = B(12)
! JVS(521) = Jac_FULL(55,21)
  JVS(521) = B(13)
! JVS(522) = Jac_FULL(55,23)
  JVS(522) = 0.22*B(107)+B(109)
! JVS(523) = Jac_FULL(55,24)
  JVS(523) = B(174)
! JVS(524) = Jac_FULL(55,26)
  JVS(524) = 0.6*B(129)
! JVS(525) = Jac_FULL(55,28)
  JVS(525) = B(83)
! JVS(526) = Jac_FULL(55,30)
  JVS(526) = B(17)+2*B(135)+0.76*B(137)
! JVS(527) = Jac_FULL(55,31)
  JVS(527) = 0.8*B(153)-B(159)
! JVS(528) = Jac_FULL(55,32)
  JVS(528) = 0.91*B(151)-B(157)
! JVS(529) = Jac_FULL(55,33)
  JVS(529) = B(155)-B(161)
! JVS(530) = Jac_FULL(55,34)
  JVS(530) = 0.26*B(111)+B(115)
! JVS(531) = Jac_FULL(55,35)
  JVS(531) = 0.07*B(141)
! JVS(532) = Jac_FULL(55,36)
  JVS(532) = 2*B(10)+B(93)+B(95)
! JVS(533) = Jac_FULL(55,37)
  JVS(533) = -B(216)
! JVS(534) = Jac_FULL(55,39)
  JVS(534) = 0.22*B(113)+B(117)
! JVS(535) = Jac_FULL(55,40)
  JVS(535) = B(178)+B(192)-B(206)+0.6*B(226)
! JVS(536) = Jac_FULL(55,41)
  JVS(536) = 0.5*B(186)+0.5*B(200)-B(214)
! JVS(537) = Jac_FULL(55,42)
  JVS(537) = B(16)
! JVS(538) = Jac_FULL(55,43)
  JVS(538) = B(14)
! JVS(539) = Jac_FULL(55,44)
  JVS(539) = B(176)+B(190)-B(204)+0.32*B(225)
! JVS(540) = Jac_FULL(55,45)
  JVS(540) = 0.33*B(20)+0.1*B(147)+0.93*B(149)
! JVS(541) = Jac_FULL(55,46)
  JVS(541) = -B(212)
! JVS(542) = Jac_FULL(55,47)
  JVS(542) = 0.9*B(18)
! JVS(543) = Jac_FULL(55,48)
  JVS(543) = 0.76*B(180)+0.9*B(194)-B(208)+0.54*B(227)
! JVS(544) = Jac_FULL(55,49)
  JVS(544) = 0.9*B(19)
! JVS(545) = Jac_FULL(55,50)
  JVS(545) = B(39)+B(43)+B(49)-B(57)+B(60)+B(84)+B(86)+B(94)+B(110)+B(116)+B(118)+0.2*B(124)+0.55*B(126)+0.6*B(130)+2&
               &*B(136)+B(175)+B(219)
! JVS(546) = Jac_FULL(55,51)
  JVS(546) = B(40)-B(41)+0.22*B(108)+0.26*B(112)+0.22*B(114)+0.76*B(138)+0.07*B(142)+0.1*B(148)
! JVS(547) = Jac_FULL(55,52)
  JVS(547) = -B(66)-B(68)
! JVS(548) = Jac_FULL(55,53)
  JVS(548) = -B(210)
! JVS(549) = Jac_FULL(55,54)
  JVS(549) = B(50)-B(78)+B(96)+0.93*B(150)+B(191)+B(193)+0.9*B(195)+0.5*B(201)
! JVS(550) = Jac_FULL(55,55)
  JVS(550) = -B(42)-B(58)-2*B(61)-2*B(62)-B(64)-B(67)-B(69)-B(79)-B(158)-B(160)-B(162)-B(205)-B(207)-B(209)-B(211)&
               &-B(213)-B(215)-B(217)
! JVS(551) = Jac_FULL(55,56)
  JVS(551) = -B(65)+0.95*B(128)+0.91*B(152)+0.8*B(154)+B(156)+B(177)+B(179)+0.76*B(181)+0.5*B(187)
! JVS(552) = Jac_FULL(56,18)
  JVS(552) = -B(127)
! JVS(553) = Jac_FULL(56,22)
  JVS(553) = B(3)
! JVS(554) = Jac_FULL(56,25)
  JVS(554) = B(29)-B(33)
! JVS(555) = Jac_FULL(56,31)
  JVS(555) = -B(153)
! JVS(556) = Jac_FULL(56,32)
  JVS(556) = -B(151)
! JVS(557) = Jac_FULL(56,33)
  JVS(557) = -B(155)
! JVS(558) = Jac_FULL(56,35)
  JVS(558) = 0
! JVS(559) = Jac_FULL(56,37)
  JVS(559) = -B(188)
! JVS(560) = Jac_FULL(56,39)
  JVS(560) = 0
! JVS(561) = Jac_FULL(56,40)
  JVS(561) = -B(178)
! JVS(562) = Jac_FULL(56,41)
  JVS(562) = -B(186)
! JVS(563) = Jac_FULL(56,42)
  JVS(563) = 0
! JVS(564) = Jac_FULL(56,44)
  JVS(564) = -B(176)
! JVS(565) = Jac_FULL(56,45)
  JVS(565) = 0
! JVS(566) = Jac_FULL(56,46)
  JVS(566) = -B(184)
! JVS(567) = Jac_FULL(56,47)
  JVS(567) = 0
! JVS(568) = Jac_FULL(56,48)
  JVS(568) = -B(180)
! JVS(569) = Jac_FULL(56,49)
  JVS(569) = 0
! JVS(570) = Jac_FULL(56,50)
  JVS(570) = -B(45)
! JVS(571) = Jac_FULL(56,51)
  JVS(571) = -B(35)
! JVS(572) = Jac_FULL(56,52)
  JVS(572) = B(1)+B(30)+B(73)
! JVS(573) = Jac_FULL(56,53)
  JVS(573) = -B(182)
! JVS(574) = Jac_FULL(56,54)
  JVS(574) = 0.11*B(2)-B(71)+B(74)
! JVS(575) = Jac_FULL(56,55)
  JVS(575) = -B(64)
! JVS(576) = Jac_FULL(56,56)
...
! End of cbmz_bb_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! cbmz_bb_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of cbmz_bb_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
