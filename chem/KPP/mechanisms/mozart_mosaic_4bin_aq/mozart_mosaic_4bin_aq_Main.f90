...
! 
! File                 : mozart_mosaic_4bin_aq_Main.f90
...
PROGRAM mozart_mosaic_4bin_aq_Driver

  USE mozart_mosaic_4bin_aq_Model
  USE mozart_mosaic_4bin_aq_Initialize, ONLY: Initialize
...
END PROGRAM mozart_mosaic_4bin_aq_Driver
