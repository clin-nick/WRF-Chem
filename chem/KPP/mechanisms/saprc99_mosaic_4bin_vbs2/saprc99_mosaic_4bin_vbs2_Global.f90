...
MODULE saprc99_mosaic_4bin_vbs2_Global

  USE saprc99_mosaic_4bin_vbs2_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE saprc99_mosaic_4bin_vbs2_Global
