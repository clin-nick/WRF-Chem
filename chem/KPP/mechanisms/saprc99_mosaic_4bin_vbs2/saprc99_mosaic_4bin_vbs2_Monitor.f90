...
MODULE saprc99_mosaic_4bin_vbs2_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '        NO2 + HO2 --> HNO4                                                                          ', &
     '             HNO4 --> NO2 + HO2                                                                     ', &
     '             HNO4 --> 0.61 NO2 + 0.39 NO3 + 0.61 HO2 + 0.39 OH                                      ', &
     '        HNO4 + OH --> NO2                                                                           ', &
     '         O3 + HO2 --> OH                                                                            ', &
     '            2 HO2 --> H2O2                                                                          ', &
     '      2 HO2 + H2O --> H2O2                                                                          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '       RO2_N + NO --> NUME + RNO3                                                                   ', &
     '      RO2_N + HO2 --> DEN + ROOH                                                                    ', &
     '     RO2_N + C_O2 --> DEN + 0.25 MEOH + 0.75 HCHO + 0.5 MEK + 0.5 PROD2 + HO2                       ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '    METHACRO + O3 --> 0.333 HCOOH + 0.9 MGLY + 0.45 CO + 0.2 HCHO + 0.1 RO2_R + 0.008 HO2 + 0.208 OH', &
     '   METHACRO + NO3 --> 0.5 CO + 0.5 HNO3 + 0.5 RO2_R + 0.5 MA_RCO3                                   ', &
     '   METHACRO + O3P --> RCHO                                                                          ', &
     '         METHACRO --> 0.67 CO + 0.67 HCHO + 0.67 CCO_O2 + 0.33 RO2_R + 0.33 MA_RCO3 + 0.34 HO2 + 0.3', &
     '         MVK + OH --> PSD1 + 0.3 MGLY + 0.675 R2O2 + 0.3 HCHO + 0.675 RCHO + 0.675 CCO_O2 + 0.3 RO2_', &
     '         MVK + O3 --> 0.351 HCOOH + 0.95 MGLY + 0.475 CO + 0.1 HCHO + 0.05 RO2_R + 0.064 HO2 + 0.164', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   ISOPRENE + NO3 --> 0.187 R2O2 + 0.936 ISOPROD + 0.749 RO2_R + 0.064 RO2_N + 0.187 NO2            ', &
     '   ISOPRENE + O3P --> 0.24 R2O2 + 0.24 HCHO + 0.75 PROD2 + 0.01 RO2_N + 0.25 C_O2 + 0.24 MA_RCO3    ', &
     ...
     '       TERP + NO3 --> 0.75 R2O2 + 0.276 RNO3 + 0.474 RCHO + 0.276 RO2_R + 0.25 RO2_N + 0.474 NO2    ', &
     ...
     '       SESQ + NO3 --> 0.75 R2O2 + 0.276 RNO3 + 0.474 RCHO + 0.276 RO2_R + 0.25 RO2_N + 0.474 NO2    ', &
     '       SESQ + O3P --> 0.147 RCHO + 0.853 PROD2                                                      ', &
     '        C2H6 + OH --> PSD1 + CCHO + RO2_R                                                           ', &
     '        C3H8 + OH --> PSD1 + 0.704 ACET + 0.261 RCHO + 0.965 RO2_R + 0.035 RO2_N                    ', &
     '        C2H2 + OH --> 0.297 HCOOH + PSD1 + 0.393 CO + 0.607 GLY + 0.096 HCHO + 0.1 RO2_R + 0.297 HO2', &
     ...
     '        ARO1 + OH --> PSD1 + 0.108 DCB2 + 0.051 DCB3 + 0.207 CRES + 0.491 DCB1 + 0.059 BALD + 0.017 ', &
     '        ARO2 + OH --> PSD1 + 0.087 BACL + 0.099 DCB2 + 0.093 DCB3 + 0.187 CRES + 0.561 DCB1 + 0.05 B', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '       OLE2 + NO3 --> 0.015 BALD + 0.102 ACET + 0.711 R2O2 + 0.507 CCHO + 0.048 MVK + 0.079 HCHO + 0', &
