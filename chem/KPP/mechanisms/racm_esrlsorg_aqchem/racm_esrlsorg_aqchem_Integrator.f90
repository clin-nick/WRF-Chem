...
! 
! File                 : racm_esrlsorg_aqchem_Integrator.f90
! Time                 : Tue Apr 12 23:43:16 2022
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  USE racm_esrlsorg_aqchem_Parameters
!!  USE racm_esrlsorg_aqchem_LinearAlgebra
  IMPLICIT NONE
...
#ifdef FULL_ALGEBRA    
     CALL racm_esrlsorg_aqchem_WCOPY(NVAR*NVAR,Jac0,1,Ghimj,1)
     CALL racm_esrlsorg_aqchem_WSCAL(NVAR*NVAR,(-ONE),Ghimj,1)
...
#ifdef FULL_ALGEBRA    
   CALL  racm_esrlsorg_aqchem_DGETRF( NVAR, NVAR, A, NVAR, Pivot, ising )
#else   
   CALL racm_esrlsorg_aqchem_KppDecomp ( A, ising )
   Pivot(1) = 1
#endif
   Ndec = Ndec + 1
...
#ifdef FULL_ALGEBRA    
   CALL  racm_esrlsorg_aqchem_DGETRS( 'N', NVAR , 1, A, NVAR, Pivot, b, NVAR, 0 )
#else   
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   USE racm_esrlsorg_aqchem_Parameters
!! USE racm_esrlsorg_aqchem_Global
!! USE racm_esrlsorg_aqchem_Function
!! USE racm_esrlsorg_aqchem_Rates
!~~~> Input variables
...
!!    CALL Update_RCONST()
#ifdef FULL_ALGEBRA    
    CALL racm_esrlsorg_aqchem_Jac_SP(Y, FIX, RCONST, JV)
    DO j=1,NVAR
      DO i=1,NVAR
         Jcb(i,j) = 0.0d0
      END DO
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racm_esrlsorg_aqchem_Fun - time derivatives of variables - Agregate form
!   Arguments :
...
! End of racm_esrlsorg_aqchem_Fun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racm_esrlsorg_aqchem_IRRFun - accumulated time derivatives of variables - Agregate form
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! End of racm_esrlsorg_aqchem_IRRFun function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~


! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racm_esrlsorg_aqchem_Jac_SP - the Jacobian of Variables in sparse matrix representation
!   Arguments :
!      V         - Concentrations of variable species (local)
!      F         - Concentrations of fixed species (local)
!      RCT       - Rate constants (local)
...
! JVS(957) = Jac_FULL(76,80)
  JVS(957) = 0
! JVS(958) = Jac_FULL(77,26)
  JVS(958) = B(24)-B(26)
! JVS(959) = Jac_FULL(77,28)
  JVS(959) = -B(210)
! JVS(960) = Jac_FULL(77,29)
  JVS(960) = -B(216)
! JVS(961) = Jac_FULL(77,30)
  JVS(961) = -B(182)
! JVS(962) = Jac_FULL(77,31)
  JVS(962) = -B(222)
! JVS(963) = Jac_FULL(77,36)
  JVS(963) = -B(192)
! JVS(964) = Jac_FULL(77,38)
  JVS(964) = -B(194)
! JVS(965) = Jac_FULL(77,39)
  JVS(965) = -B(190)
! JVS(966) = Jac_FULL(77,40)
  JVS(966) = 0
! JVS(967) = Jac_FULL(77,41)
  JVS(967) = -B(188)
! JVS(968) = Jac_FULL(77,43)
  JVS(968) = -B(200)
! JVS(969) = Jac_FULL(77,48)
  JVS(969) = -B(196)
! JVS(970) = Jac_FULL(77,50)
  JVS(970) = 0
! JVS(971) = Jac_FULL(77,54)
  JVS(971) = 0
! JVS(972) = Jac_FULL(77,61)
  JVS(972) = -B(198)
! JVS(973) = Jac_FULL(77,63)
  JVS(973) = -B(184)
! JVS(974) = Jac_FULL(77,65)
  JVS(974) = -B(186)
! JVS(975) = Jac_FULL(77,72)
  JVS(975) = B(298)
! JVS(976) = Jac_FULL(77,73)
  JVS(976) = -B(32)
! JVS(977) = Jac_FULL(77,74)
  JVS(977) = 0
! JVS(978) = Jac_FULL(77,75)
  JVS(978) = -B(34)+B(299)+B(302)
! JVS(979) = Jac_FULL(77,76)
  JVS(979) = 0
! JVS(980) = Jac_FULL(77,77)
  JVS(980) = -B(2)-B(3)-B(27)-B(33)-B(35)-B(68)-B(70)-B(183)-B(185)-B(187)-B(189)-B(191)-B(193)-B(195)-B(197)-B(199)&
               &-B(201)-B(211)-B(217)-B(223)
! JVS(981) = Jac_FULL(77,78)
  JVS(981) = B(303)
! JVS(982) = Jac_FULL(77,79)
  JVS(982) = -B(69)
! JVS(983) = Jac_FULL(77,80)
  JVS(983) = -B(71)
! JVS(984) = Jac_FULL(78,43)
  JVS(984) = B(229)
! JVS(985) = Jac_FULL(78,61)
  JVS(985) = B(20)+0.5*B(136)+0.5*B(162)
! JVS(986) = Jac_FULL(78,72)
  JVS(986) = -B(378)
! JVS(987) = Jac_FULL(78,73)
  JVS(987) = 0.5*B(137)
! JVS(988) = Jac_FULL(78,74)
  JVS(988) = 0.5*B(163)-B(420)
! JVS(989) = Jac_FULL(78,75)
  JVS(989) = -B(300)-B(302)
! JVS(990) = Jac_FULL(78,76)
  JVS(990) = -B(341)-B(343)
! JVS(991) = Jac_FULL(78,77)
  JVS(991) = 0
! JVS(992) = Jac_FULL(78,78)
  JVS(992) = -B(227)-B(260)-B(301)-B(303)-B(342)-B(344)-B(379)-B(421)
! JVS(993) = Jac_FULL(78,79)
  JVS(993) = -B(261)
! JVS(994) = Jac_FULL(78,80)
  JVS(994) = -B(228)
! JVS(995) = Jac_FULL(79,23)
  JVS(995) = B(4)
! JVS(996) = Jac_FULL(79,26)
  JVS(996) = -B(43)+B(45)
! JVS(997) = Jac_FULL(79,28)
  JVS(997) = 0
! JVS(998) = Jac_FULL(79,29)
  JVS(998) = 0
! JVS(999) = Jac_FULL(79,31)
  JVS(999) = 0
! JVS(1000) = Jac_FULL(79,40)
  JVS(1000) = 0
! JVS(1001) = Jac_FULL(79,41)
  JVS(1001) = 0
! JVS(1002) = Jac_FULL(79,42)
  JVS(1002) = -B(444)
! JVS(1003) = Jac_FULL(79,45)
  JVS(1003) = -B(240)
! JVS(1004) = Jac_FULL(79,46)
  JVS(1004) = -B(242)
! JVS(1005) = Jac_FULL(79,47)
  JVS(1005) = -B(244)
! JVS(1006) = Jac_FULL(79,48)
  JVS(1006) = 0
! JVS(1007) = Jac_FULL(79,50)
  JVS(1007) = -B(246)
! JVS(1008) = Jac_FULL(79,52)
  JVS(1008) = -B(256)
! JVS(1009) = Jac_FULL(79,53)
  JVS(1009) = -B(238)
! JVS(1010) = Jac_FULL(79,54)
  JVS(1010) = -B(250)
! JVS(1011) = Jac_FULL(79,55)
  JVS(1011) = -B(236)
! JVS(1012) = Jac_FULL(79,57)
  JVS(1012) = -B(252)
! JVS(1013) = Jac_FULL(79,58)
  JVS(1013) = -B(254)
! JVS(1014) = Jac_FULL(79,59)
  JVS(1014) = -B(248)
! JVS(1015) = Jac_FULL(79,62)
  JVS(1015) = -B(435)
! JVS(1016) = Jac_FULL(79,63)
  JVS(1016) = 0
! JVS(1017) = Jac_FULL(79,65)
  JVS(1017) = 0
! JVS(1018) = Jac_FULL(79,66)
  JVS(1018) = -B(264)
! JVS(1019) = Jac_FULL(79,67)
  JVS(1019) = -B(266)
! JVS(1020) = Jac_FULL(79,68)
  JVS(1020) = -B(232)
! JVS(1021) = Jac_FULL(79,69)
  JVS(1021) = -B(262)
! JVS(1022) = Jac_FULL(79,70)
  JVS(1022) = 0
! JVS(1023) = Jac_FULL(79,71)
  JVS(1023) = -B(234)
! JVS(1024) = Jac_FULL(79,72)
  JVS(1024) = -B(258)
! JVS(1025) = Jac_FULL(79,73)
  JVS(1025) = -B(49)
! JVS(1026) = Jac_FULL(79,74)
  JVS(1026) = B(7)-B(74)+B(76)
! JVS(1027) = Jac_FULL(79,75)
  JVS(1027) = -B(55)
! JVS(1028) = Jac_FULL(79,76)
  JVS(1028) = -B(230)
! JVS(1029) = Jac_FULL(79,77)
  JVS(1029) = -B(68)
! JVS(1030) = Jac_FULL(79,78)
  JVS(1030) = -B(260)
! JVS(1031) = Jac_FULL(79,79)
...
! JVS(1032) = Jac_FULL(79,80)
  JVS(1032) = B(1)+B(46)+B(77)
! JVS(1033) = Jac_FULL(80,11)
  JVS(1033) = B(80)
! JVS(1034) = Jac_FULL(80,18)
  JVS(1034) = B(88)
! JVS(1035) = Jac_FULL(80,19)
  JVS(1035) = 0.65*B(6)+B(59)+B(66)
! JVS(1036) = Jac_FULL(80,21)
  JVS(1036) = B(406)+B(451)
! JVS(1037) = Jac_FULL(80,23)
  JVS(1037) = B(62)
! JVS(1038) = Jac_FULL(80,26)
  JVS(1038) = B(43)-B(45)-B(47)
! JVS(1039) = Jac_FULL(80,27)
  JVS(1039) = -B(202)
! JVS(1040) = Jac_FULL(80,28)
  JVS(1040) = -B(206)
! JVS(1041) = Jac_FULL(80,29)
  JVS(1041) = -B(212)
! JVS(1042) = Jac_FULL(80,31)
  JVS(1042) = -B(218)
! JVS(1043) = Jac_FULL(80,32)
  JVS(1043) = B(5)
! JVS(1044) = Jac_FULL(80,34)
  JVS(1044) = 0
! JVS(1045) = Jac_FULL(80,35)
  JVS(1045) = B(226)
! JVS(1046) = Jac_FULL(80,39)
  JVS(1046) = 0
! JVS(1047) = Jac_FULL(80,40)
  JVS(1047) = 0
! JVS(1048) = Jac_FULL(80,41)
  JVS(1048) = 0
! JVS(1049) = Jac_FULL(80,42)
  JVS(1049) = B(444)-B(449)
! JVS(1050) = Jac_FULL(80,43)
  JVS(1050) = 0.4*B(180)+0.7*B(200)+B(229)
! JVS(1051) = Jac_FULL(80,44)
  JVS(1051) = 0
! JVS(1052) = Jac_FULL(80,45)
  JVS(1052) = B(240)+B(400)
! JVS(1053) = Jac_FULL(80,46)
  JVS(1053) = B(242)+B(402)
! JVS(1054) = Jac_FULL(80,47)
  JVS(1054) = B(244)+B(404)
! JVS(1055) = Jac_FULL(80,48)
  JVS(1055) = 0
! JVS(1056) = Jac_FULL(80,50)
  JVS(1056) = B(246)
! JVS(1057) = Jac_FULL(80,51)
  JVS(1057) = 0
! JVS(1058) = Jac_FULL(80,52)
  JVS(1058) = B(256)+B(416)
! JVS(1059) = Jac_FULL(80,53)
  JVS(1059) = 0.739*B(238)+B(398)
! JVS(1060) = Jac_FULL(80,54)
  JVS(1060) = 0.65*B(250)+B(410)
! JVS(1061) = Jac_FULL(80,55)
  JVS(1061) = 0.876*B(236)+B(396)
! JVS(1062) = Jac_FULL(80,56)
  JVS(1062) = 0
! JVS(1063) = Jac_FULL(80,57)
  JVS(1063) = 0.95*B(252)+B(412)
! JVS(1064) = Jac_FULL(80,58)
  JVS(1064) = 0.95*B(254)+B(414)
! JVS(1065) = Jac_FULL(80,59)
  JVS(1065) = 0.8*B(248)+B(408)
! JVS(1066) = Jac_FULL(80,60)
  JVS(1066) = B(21)+B(150)
! JVS(1067) = Jac_FULL(80,61)
  JVS(1067) = 0.5*B(162)
! JVS(1068) = Jac_FULL(80,62)
  JVS(1068) = B(435)+B(437)
! JVS(1069) = Jac_FULL(80,63)
  JVS(1069) = 0
! JVS(1070) = Jac_FULL(80,64)
  JVS(1070) = 0
! JVS(1071) = Jac_FULL(80,65)
  JVS(1071) = 0
! JVS(1072) = Jac_FULL(80,66)
  JVS(1072) = B(264)+0.5*B(387)+B(424)
! JVS(1073) = Jac_FULL(80,67)
  JVS(1073) = 2*B(266)+0.5*B(349)+0.516*B(384)+0.5*B(388)+B(389)+2*B(426)
! JVS(1074) = Jac_FULL(80,68)
  JVS(1074) = B(232)+B(392)
! JVS(1075) = Jac_FULL(80,69)
  JVS(1075) = B(262)+B(422)
! JVS(1076) = Jac_FULL(80,70)
  JVS(1076) = 0
! JVS(1077) = Jac_FULL(80,71)
  JVS(1077) = 0.941*B(234)+B(394)
! JVS(1078) = Jac_FULL(80,72)
  JVS(1078) = -B(224)+B(258)+0.516*B(385)+B(418)
! JVS(1079) = Jac_FULL(80,73)
  JVS(1079) = -B(51)+B(53)+B(63)+B(67)+B(89)+B(151)+B(407)
! JVS(1080) = Jac_FULL(80,74)
...
! JVS(1081) = Jac_FULL(80,75)
  JVS(1081) = B(55)-B(57)+0.7*B(61)
! JVS(1082) = Jac_FULL(80,76)
  JVS(1082) = B(230)+0.5*B(350)+B(391)
! JVS(1083) = Jac_FULL(80,77)
  JVS(1083) = B(68)-B(70)+0.7*B(201)
! JVS(1084) = Jac_FULL(80,78)
  JVS(1084) = -B(227)+B(260)+B(421)
! JVS(1085) = Jac_FULL(80,79)
...
! End of racm_esrlsorg_aqchem_Jac_SP function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! 
! racm_esrlsorg_aqchem_KppSolve - sparse back substitution
!   Arguments :
!      JVS       - sparse Jacobian of variables
...
! End of racm_esrlsorg_aqchem_KppSolve function
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
