...
! 
! File                 : racm_esrlsorg_aqchem_Global.f90
...
MODULE racm_esrlsorg_aqchem_Global

  USE racm_esrlsorg_aqchem_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE racm_esrlsorg_aqchem_Global
