...
!
#include <extra_args_update_rconst_nmhc9.inc>
!
...
!
#include <extra_decls_update_rconst_nmhc9.inc>
!
...
!  real Troe rate constants: for OH + NO2 -> HNO3, Dransfield et al. 1999 (GRL)
      ...
      Trat = T/Tc
      dN=sign(0.1_dp-0.2605766891419492_dp*Trat,1.-bcrit) ! 0.26=0.6*.434;log-->.33
      N = 0.75_dp + 0.5515539920171264_dp*Trat           ! 0.55=1.27*.434;log-->.33
...
!old      RX1= 2.3D-13 *EXP(600._dp/T)
      RX1= 1.5D-12 *EXP(19._dp/T)         ! new: Christensen etal. 2002 (GRL,29(.33
