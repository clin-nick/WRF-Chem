...
! 
! File                 : cb05_sorg_vbs_aq_Global.f90
...
MODULE cb05_sorg_vbs_aq_Global

  USE cb05_sorg_vbs_aq_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE cb05_sorg_vbs_aq_Global
