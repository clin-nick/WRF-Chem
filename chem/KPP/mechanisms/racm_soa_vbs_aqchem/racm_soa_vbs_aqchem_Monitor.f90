...
! 
! File                 : racm_soa_vbs_aqchem_Monitor.f90
...
MODULE racm_soa_vbs_aqchem_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_0 = (/ &
     ...
     '        HONO --> HO + NO                                                                            ', &
     '        HNO3 --> HO + NO2                                                                           ', &
     '        HNO4 --> 0.35 HO + 0.65 HO2 + 0.65 NO2 + 0.35 NO3                                           ', &
     '         NO3 --> NO                                                                                 ', &
     '         NO3 --> O3P + NO2                                                                          ', &
     '        H2O2 --> 2 HO                                                                               ', &
     '        HCHO --> CO                                                                                 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '   MGLY + HO --> CO + ACO3 + H2O                                                                    ', &
     '   MACR + HO --> MACP                                                                               ', &
     '    DCB + HO --> 0.35 UDD + 0.15 GLY + 0.15 MGLY + 0.5 XO2 + 0.5 TCO3 + 0.5 HO2                     ', &
     '    UDD + HO --> 0.12 KET + 0.88 ALD + HO2                                                          ', &
     '    OP1 + HO --> 0.35 HCHO + 0.65 MO2 + 0.35 HO                                                     ', &
     '    HO + OP2 --> 0.41 KET + 0.07 XO2 + 0.08 ALD + 0.44 HC3P + 0.49 HO                               ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '   MAHP + HO --> MACP                                                                               ', &
     '   DCB + NO3 --> 0.5 HNO3 + 0.25 GLY + 0.03 KET + 0.25 MGLY + 0.5 XO2 + 0.25 ALD + 0.5 TCO3 + 0.5 HO', &
     '   CSL + NO3 --> PHO + HNO3                                                                         ', &
     '   ETE + NO3 --> 0.2 OLND + 0.8 OLNN                                                                ', &
     '   OLT + NO3 --> 0.57 OLND + 0.43 OLNN                                                              ', &
     '   OLI + NO3 --> 0.89 OLND + 0.11 OLNN                                                              ', &
     '  DIEN + NO3 --> 0.9 MACR + 0.1 OLND + 0.9 OLNN                                                     ', &
     '   ISO + NO3 --> ISON                                                                               ', &
     '   API + NO3 --> 0.9 OLND + 0.1 OLNN                                                                ', &
     '   LIM + NO3 --> 0.87 OLND + 0.13 OLNN                                                              ', &
     ...
     '    ISO + O3 --> 0.28 ORA1 + 0.09 H2O2 + 0.14 CO + 0.1 MACP + 0.65 MACR + 0.58 HCHO + 0.1 ACO3 + 0.0', &
     '    API + O3 --> 0.02 H2O2 + 0.14 CO + 0.53 KET + 0.65 ALD + 0.42 KETP + 0.85 HO + 0.1 HO2 + 0.2 ETH', &
     ...
     '    DCB + O3 --> 0.11 ORA1 + 0.21 ORA2 + 0.11 PAA + 0.66 CO + 0.5 GLY + 0.62 MGLY + 0.16 ALD + 0.28 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    MO2 + NO --> HCHO + HO2 + NO2                                                                   ', &
     '   NO + ETHP --> ALD + HO2 + NO2                                                                    ', &
     '   HC3P + NO --> 0.063 GLY + 0.623 KET + 0.047 HCHO + 0.059 ONIT + 0.048 XO2 + 0.233 ALD + 0.15 MO2 ', &
     '   HC5P + NO --> 0.722 KET + 0.021 HCHO + 0.124 ONIT + 0.334 XO2 + 0.211 ALD + 0.031 MO2 + 0.599 HO2', &
     '   HC8P + NO --> 0.642 KET + 0.261 ONIT + 0.416 XO2 + 0.15 ALD + 0.606 HO2 + 0.739 NO2 + 0.133 ETHP ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '  HC3P + MO2 --> 0.119 GLY + 0.018 KET + 0.005 MGLY + 0.81 HCHO + 0.085 XO2 + 0.58 ALD + 0.007 MO2 +', &
     '  HC5P + MO2 --> 0.24 KET + 0.829 HCHO + 0.245 XO2 + 0.523 ALD + 0.049 MO2 + 0.946 HO2 + 0.014 ETHP ', &
     '  HC8P + MO2 --> 0.419 KET + 0.753 HCHO + 0.322 XO2 + 0.411 ALD + 0.993 HO2 + 0.013 ETHP            ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     ' ACO3 + ETHP --> 0.5 ORA2 + ALD + 0.5 MO2 + 0.5 HO2                                                 ', &
     ' HC3P + ACO3 --> 0.499 ORA2 + 0.1 GLY + 0.127 KET + 0.004 MGLY + 0.091 HCHO + 0.071 XO2 + 0.724 ALD ', &
     ' HC5P + ACO3 --> 0.495 ORA2 + 0.33 KET + 0.076 HCHO + 0.237 XO2 + 0.677 ALD + 0.554 MO2 + 0.438 HO2 ', &
     ' HC8P + ACO3 --> 0.495 ORA2 + 0.581 KET + 0.318 XO2 + 0.497 ALD + 0.507 MO2 + 0.489 HO2 + 0.015 ETHP', &
     ...
     ' ISOP + ACO3 --> 0.494 ORA2 + 0.771 MACR + 0.34 HCHO + 0.229 OLT + 0.506 MO2 + 0.506 HO2            ', &
     ...
     ' KETP + ACO3 --> 0.5 ORA2 + 0.11 KET + 0.54 MGLY + 0.08 XO2 + 0.35 ALD + 0.12 ACO3 + 0.5 MO2 + 0.38 ', &
     ' OLNN + ACO3 --> 0.5 ORA2 + ONIT + 0.5 MO2 + 0.5 HO2                                                ', &
     ' OLND + ACO3 --> 0.484 ORA2 + 0.167 KET + 0.207 HCHO + 0.484 ONIT + 0.65 ALD + 0.516 MO2 + 0.516 NO2', &
     '      2 OLNN --> 2 ONIT + HO2                                                                       ', &
     ' OLND + OLNN --> 0.149 KET + 0.202 HCHO + 1.5 ONIT + 0.64 ALD + 0.5 HO2 + 0.5 NO2                   ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '  HC3P + NO3 --> 0.063 GLY + 0.67 KET + 0.048 HCHO + 0.051 XO2 + 0.243 ALD + 0.155 MO2 + 0.792 HO2 +', &
     '  HC5P + NO3 --> 0.828 KET + 0.021 HCHO + 0.391 XO2 + 0.239 ALD + 0.04 MO2 + 0.699 HO2 + NO2 + 0.262', &
     '  HC8P + NO3 --> 0.88 KET + 0.587 XO2 + 0.187 ALD + 0.845 HO2 + NO2 + 0.155 ETHP                    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(16) :: EQN_NAMES_8 = (/ &
     ...
     '  MACP + NO2 --> MPAN                                                                               ', &
     '        MPAN --> MACP + NO2                                                                         ', &
     '   SESQ + HO --> 0.05 ORA1 + 0.36 KET + 0.3 HCHO + 0.19 OLIP                                        ', &
     '   SESQ + O3 --> 0.039 ORA1 + 0.053 ORA2 + 0.23 KET + 0.51 HCHO + 0.85 ALD + 0.63 HO                ', &
     '  SESQ + NO3 --> 0.9 MACR + 0.1 OLND + 0.9 OLNN                                                     ', &
     '    MBO + HO --> OLIP                                                                               ', &
     '   MBO + NO3 --> 0.89 OLND + 0.11 OLNN                                                              ', &
     '    MBO + O3 --> 0.14 ORA2 + 0.06 ETH + 0.07 CH4 + 0.011 H2O2 + 0.3 CO + 0.16 KET + 0.02 HCHO + 0.99', &
...
END MODULE racm_soa_vbs_aqchem_Monitor
