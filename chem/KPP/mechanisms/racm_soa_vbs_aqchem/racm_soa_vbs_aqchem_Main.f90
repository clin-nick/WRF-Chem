...
! 
! File                 : racm_soa_vbs_aqchem_Main.f90
...
PROGRAM racm_soa_vbs_aqchem_Driver

  USE racm_soa_vbs_aqchem_Model
  USE racm_soa_vbs_aqchem_Initialize, ONLY: Initialize
...
END PROGRAM racm_soa_vbs_aqchem_Driver
