...
! 
! File                 : racm_soa_vbs_aqchem_Global.f90
...
MODULE racm_soa_vbs_aqchem_Global

  USE racm_soa_vbs_aqchem_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE racm_soa_vbs_aqchem_Global
