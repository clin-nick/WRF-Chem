...
! 
! File                 : cri_mosaic_8bin_aq_Global.f90
...
MODULE cri_mosaic_8bin_aq_Global

  USE cri_mosaic_8bin_aq_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE cri_mosaic_8bin_aq_Global
