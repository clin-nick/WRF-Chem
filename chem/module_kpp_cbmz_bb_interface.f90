...
MODULE module_kpp_cbmz_bb_interf 
  ...
  USE cbmz_bb_UpdateRconstWRF
  USE cbmz_bb_Integrator
...
SUBROUTINE  cbmz_bb_interface( &
  ...
  CALL cbmz_bb_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  cbmz_bb_interface


END MODULE module_kpp_cbmz_bb_interf 
