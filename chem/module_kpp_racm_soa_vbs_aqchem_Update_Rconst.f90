...
MODULE racm_soa_vbs_aqchem_UpdateRconstWRF
...
SUBROUTINE racm_soa_vbs_aqchem_Update_RCONST(  &
...
END SUBROUTINE racm_soa_vbs_aqchem_Update_RCONST
...
END MODULE racm_soa_vbs_aqchem_UpdateRconstWRF
