...
MODULE module_kpp_cri_mosaic_4bin_aq_interf 
  ...
  USE cri_mosaic_4bin_aq_UpdateRconstWRF
  USE cri_mosaic_4bin_aq_Integrator
...
SUBROUTINE  cri_mosaic_4bin_aq_interface( &
  ...
  REAL( KIND = dp ) :: RO2
   ...
   CALL cri_mosaic_4bin_aq_Update_Rconst(  &
...
ind_rtx28o2,ind_rn19o2,ind_nrn12ooh,ind_hoch2co3,ind_no2, &
  ...
  CALL cri_mosaic_4bin_aq_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  cri_mosaic_4bin_aq_interface


END MODULE module_kpp_cri_mosaic_4bin_aq_interf 
