...
MODULE module_kpp_racm_soa_vbs_aqchem_interf 
  ...
  USE racm_soa_vbs_aqchem_UpdateRconstWRF
  USE racm_soa_vbs_aqchem_Integrator
...
SUBROUTINE  racm_soa_vbs_aqchem_interface( &
...
REAL( KIND = dp ) :: rc_n2o5
   ...
   CALL racm_soa_vbs_aqchem_Update_Rconst(  &
  ...
  CALL racm_soa_vbs_aqchem_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racm_soa_vbs_aqchem_interface


END MODULE module_kpp_racm_soa_vbs_aqchem_interf 
