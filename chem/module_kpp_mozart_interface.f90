...
MODULE module_kpp_mozart_interf 
  ...
  USE mozart_UpdateRconstWRF
  USE mozart_Integrator
...
SUBROUTINE  mozart_interface( &
  ...
  CALL mozart_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  mozart_interface


END MODULE module_kpp_mozart_interf 
