...
MODULE module_kpp_racm_esrlsorg_interf 
  ...
  USE racm_esrlsorg_UpdateRconstWRF
  USE racm_esrlsorg_Integrator
...
SUBROUTINE  racm_esrlsorg_interface( &
   ...
   CALL racm_esrlsorg_Update_Rconst(  &
  ...
  CALL racm_esrlsorg_INTEGRATE(TIME_START, TIME_END, &  
...
END SUBROUTINE  racm_esrlsorg_interface


END MODULE module_kpp_racm_esrlsorg_interf 
